...
#line 154 "ArithmeticExpressionParser.cc" // lalr1.cc:479
  ...
  inline
  ArithmeticExpressionParser::syntax_error::syntax_error (const location_type& l, const std::string& m)
    : std::runtime_error (m)
    , location (l)
  {}
  ...
  inline
  ArithmeticExpressionParser::basic_symbol<Base>::basic_symbol ()
    : value ()
  {}

  template <typename Base>
  inline
  ArithmeticExpressionParser::basic_symbol<Base>::basic_symbol (const basic_symbol& other)
    : Base (other)
    , value ()
  ...
  template <typename Base>
  inline
  ArithmeticExpressionParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const semantic_type& v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  inline
  ArithmeticExpressionParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {}
  ...
  inline
  void
  ArithmeticExpressionParser::basic_symbol<Base>::clear ()
  {
    Base::clear ();
  }
  ...
  inline
  bool
  ArithmeticExpressionParser::basic_symbol<Base>::empty () const
  {
  ...
  // by_type.
  inline
  ArithmeticExpressionParser::by_type::by_type ()
    : type (empty_symbol)
  {}

  inline
  ArithmeticExpressionParser::by_type::by_type (const by_type& other)
    : type (other.type)
  {}

  inline
  ArithmeticExpressionParser::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}

  inline
  void
  ArithmeticExpressionParser::by_type::clear ()
  {
    type = empty_symbol;
  }
  ...
  inline
  void
  ArithmeticExpressionParser::by_type::move (by_type& that)
  {
    type = that.type;
    that.clear ();
  }
  ...
  inline
  int
  ArithmeticExpressionParser::by_type::type_get () const
  {
    return type;
  }
  ...
  // by_state.
  inline
  ArithmeticExpressionParser::by_state::by_state ()
    : state (empty_state)
  {}

  inline
  ArithmeticExpressionParser::by_state::by_state (const by_state& other)
    : state (other.state)
  {}

  inline
  void
  ArithmeticExpressionParser::by_state::clear ()
  {
    state = empty_state;
  }
  ...
  inline
  void
  ArithmeticExpressionParser::by_state::move (by_state& that)
  {
    state = that.state;
    that.clear ();
  }
  ...
  inline
  ArithmeticExpressionParser::by_state::by_state (state_type s)
    : state (s)
  {}

  inline
  ArithmeticExpressionParser::symbol_number_type
  ...
  inline
  ArithmeticExpressionParser::stack_symbol_type::stack_symbol_type ()
  {}


  inline
  ArithmeticExpressionParser::stack_symbol_type::stack_symbol_type (state_type s, symbol_type& that)
  ...
  inline
  ArithmeticExpressionParser::stack_symbol_type&
  ArithmeticExpressionParser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    state = that.state;
    value = that.value;
  ...
  inline
  void
  ArithmeticExpressionParser::yy_destroy_ (const char* yymsg, basic_symbol<Base>& yysym) const
  {
    if (yymsg)
  ...
  template <typename Base>
  void
  ArithmeticExpressionParser::yy_print_ (std::ostream& yyo,
...
#line 433 "ArithmeticExpressionParser.cc" // lalr1.cc:636
  ...
  inline
  void
  ArithmeticExpressionParser::yypush_ (const char* m, state_type s, symbol_type& sym)
  {
  ...
  inline
  void
  ArithmeticExpressionParser::yypush_ (const char* m, stack_symbol_type& s)
  {
    if (m)
      YY_SYMBOL_PRINT (m, s);
    yystack_.push (s);
...
#line 116 "ArithmeticExpressionParser.yy" // lalr1.cc:859
    { (yylhs.value.fval) = (*(yystack_[3].value.func))((yystack_[1].value.fval)); }
#line 665 "ArithmeticExpressionParser.cc" // lalr1.cc:859
    break;

  case 5:
#line 117 "ArithmeticExpressionParser.yy" // lalr1.cc:859
    { (yylhs.value.fval) = (yystack_[2].value.fval) + (yystack_[0].value.fval); }
...
#line 122 "ArithmeticExpressionParser.yy" // lalr1.cc:859
    { (yylhs.value.fval) = std::pow((yystack_[2].value.fval), (yystack_[0].value.fval)); }
...
#line 711 "ArithmeticExpressionParser.cc" // lalr1.cc:859
  ...
  void
  ArithmeticExpressionParser::error (const syntax_error& yyexc)
  {
  ...
  std::string
  ArithmeticExpressionParser::yysyntax_error_ (state_type yystate, const symbol_type& yyla) const
  {
