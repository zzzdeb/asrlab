...
public:
  ...
  public:
    ...
    f64 fbScore;  // unormalized fwd/bwd score; from-state-fwd-score + arc-score
                  // + to-state-bwd-score
...
public:
  ...
  */
  ...
  static std::pair<ConstLatticeRef, ConstFwdBwdRef>
  build(ConstLatticeRef l, const FwdBwd::Parameters &params);
  static std::pair<ConstLatticeRef, ConstFwdBwdRef>
  build(ConstLatticeRef l,
  ...
  */
  ...
  static std::pair<ConstLatticeRef, ConstFwdBwdRef>
  build(const ConstLatticeRefList &lats,
        const FwdBwd::CombinationParameters &params);
  static std::pair<ConstLatticeRef, ConstFwdBwdRef> build(
      const ConstLatticeRefList &lats, const ScoreList &weights = ScoreList(),
...
public:
  ...
  */
  ...
  /*
    Factory method:
  */
  static FwdBwdBuilderRef
  create(const Core::Configuration &config,
         const KeyList &extensionKeys = KeyList(),
         const ScoreList &extensionScales = ScoreList());
};
