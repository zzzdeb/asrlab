...
public:
  ...
  static TimeframeErrorRef create(ConstLatticeRef lHyp, ConstLatticeRef lRef,
                                  Score alpha = 0.05);
  static TimeframeErrorRef
  create(ConstLatticeRef lHyp, ConstPosteriorCnRef cnRef, Score alpha = 0.05);
};
