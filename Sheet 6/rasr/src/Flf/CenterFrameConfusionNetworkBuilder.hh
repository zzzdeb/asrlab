...
/**
   CN construction algorithm based on the selection of a frame representing the
center of the next CN slot, for details see my thesis, chapter 4.4.4 (The
Center-Frame CN Construction Algorithm)
**/
...
public:
  ...
  */
  ...
  virtual void reset();
  virtual ConstConfusionNetworkRef getCn(ScoreId posteriorId,
                                         bool mapping) const;
  virtual std::pair<ConstConfusionNetworkRef, ConstLatticeRef>
  getNormalizedCn(ScoreId confidenceId, bool mapping) const;
};
