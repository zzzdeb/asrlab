...
void registerNodeCreators(NodeFactory *factory) {
  ...
  /*
    Initial nodes
  */
  factory->add(NodeCreator("speech-segment",
  ...
  */
  ...
  factory->add(
      NodeCreator("archive-reader",
                  ...
                  "[*.network.archive-reader.flf]\n"
                  "input-alphabet.name         = "
                  "{lemma-pronunciation*|lemma|syntax|evaluation}\n"
                  "input-alphabet.format       = bin\n"
                  "input-alphabet.file         = <alphabet-file>\n"
                  "output-alphabet.name        = "
                  "{lemma-pronunciation*|lemma|syntax|evaluation}\n"
  ...
  factory->add(NodeCreator(
      "archive-writer", "Store lattices in archive.",
  ...
  /*
    Flow
  */
  factory->add(NodeCreator("sink", "Let all incoming lattices/CNs/fCNs sink.",
                           "[*.network.sink]\n"
                           "type                        = sink\n"
                           ...
                           "no output",
                           &createSink));
  factory->add(NodeCreator("buffer",
  ...
  */
  factory->add(
      NodeCreator("best",
                  ...
                  "type                        = best\n"
                  "algorithm                   = "
                  "dijkstra*|bellman-ford|projecting-bellman-ford",
                  "input:\n"
                  "  0:lattice\n"
                  "output:\n"
                  "  0:lattice",
                  &createBestNode));
  factory->add(NodeCreator("n-best",
  ...
  factory->add(NodeCreator("dump-n-best",
                           "Dumps a linear or n-best-list lattice.",
                           "[*.network.dump-n-best]\n"
                           "type                        = dump-n-best\n"
                           "dump.channel                = <file>\n"
                           "scores                      = <key-1> <key-2> ... "
                           "# default is all scores",
                           "input:\n"
  ...
  factory->add(NodeCreator(
      ...
      "For tracebacks in Bliss format, the lattice is mapped to "
      "lemma-pronunciation.\n"
      "The CTM format is independent of the input alphabet; if the "
      "\"dump-orthography\"\n"
      "option is active, the lattice is mapped to lemma.\n"
      "For phoneme or subword alignments, the input alphabet must be lemma or "
      "lemma-\n"
      "pronunciation and at port 1 a valid Bliss-segment is required. If an "
      "alignment\n"
      "for a lemma is requested, the result is the Viterbi alignment over all "
      "matching\n"
      "pronunciations.",
      ...
      "non-word-symbol             = <unset> # use lexicon representation for "
      "non-words \n"
      "                                        and !NULL for eps arcs; if set, "
      "then use\n"
  ...
  /*
    Evaluation
  */
  factory->add(NodeCreator("evaluator", "Calculate WER and/or GER.",
                           "[*.network.evaluator]\n"
                           "type                        = evaluator\n"
                           "single-best                 = true\n"
  ...
  /*
    Composition
  */
  factory->add(NodeCreator("compose", "see compose-matching",
                           "[*.network.compose]\n"
                           "type                        = compose",
                           "see compose-matching", &createComposeMatchingNode));
  factory->add(
      NodeCreator("compose-matching",
  ...
  factory->add(
      NodeCreator("compose-sequencing",
                  "Compose two lattices; for algorithm details see FSA.",
  ...
  factory->add(NodeCreator(
      ...
      "sentence end, regardless of any arcs labeled with the sentence end "
      "symbol.\n",
  ...
  */
  ...
  factory->add(NodeCreator(
      ...
      "dependent:\n"
      "First, a list of class labels is defined. Second, each class label "
      "gets\n"
  ...
  factory->add(NodeCreator("append",
  ...
  */
  ...
  factory->add(NodeCreator(
      "reduce",
      "Reduce the scores of two or more dimensions to the first given "
      "dimension.\n"
      "Basically the weighted score of the second, third, and so on key\n"
      "are added to the first score of the first key and then set to semiring "
      "one,\n"
  ...
  factory->add(NodeCreator(
      "project",
      "Change the semiring by projecting the source semiring onto the target "
      "semiring.",
      "[*.network.projection]\n"
      "type                        = project\n"
      "scaled                      = true\n"
  ...
  */
  factory->add(NodeCreator(
      "determinize", "Determinize lattice; for algorithm details see FSA.",
      "[*.network.determinize]\n"
      "type                        = determinize\n"
  ...
  */
  ...
  factory->add(NodeCreator(
      ...
      "having source state s'. Pathes_s'/w(s,e) is the subset of "
      "Pathes_w(s,e),\n"
      "such that each path in Pathes_s'/w(s,e) includes an arc in "
      "Arcs_s'/w(s,e).\n"
      "\n"
      "for each w, (s,e):\n"
      ...
      "\n"
      "The resulting graph is a subgraph of the original input and contains "
      "the\n"
  ...
  */
  ...
  factory->add(NodeCreator(
      "map-alphabet",
      "Map the input(output, or both) labels of the incoming lattice to "
      "another\n"
      "alphabet. The concrete mapping is specified by the used lexicon.\n"
      "If the incoming lattice is an acceptor and output mapping is "
      "activated,\n"
      ...
      "type                        = map-alphabet\n"
      "map-input                   = "
      "to-phoneme|to-lemma|to-lemma-pron|to-preferred-lemma-pron|to-synt|to-"
      "eval|to-preferred-eval\n"
      "map-output                  = "
      "to-phoneme|to-lemma|to-lemma-pron|to-preferred-lemma-pron|to-synt|to-"
      "eval|to-preferred-eval\n"
      "project-input               = false\n"
  ...
  factory->add(NodeCreator(
      ...
      "  0:lattice",
      &createLabelMapNode));
  factory->add(NodeCreator("filter", "Filter lattice by input(output).",
                           "[*.network.filter]\n"
                           "type                        = filter\n"
                           "input                       = <unset>\n"
                           "output                      = <unset>",
  ...
  factory->add(
      NodeCreator("mesh",
                  ...
                  "  0:lattice",
                  &createMeshNode));
  factory->add(NodeCreator("properties",
  ...
  factory->add(NodeCreator(
      ...
      "  score.key only, or of the concatenated scores of the incoming "
      "lattices.\n"
      "  Optionally, a label identifying the source system is set as the "
      "output label\n"
      ...
      "cost.key                    = <unset> # required, if risk.key is "
      "specified\n"
   ...
   * fCN
   **/
  factory->add(NodeCreator("fCN-archive-reader",
  ...
  factory->add(
      NodeCreator("fCN-archive-writer", "Store posterior CNs in archive.",
  ...
  factory->add(
      NodeCreator("fCN-gamma-correction",
  ...
  factory->add(
      NodeCreator("add-word-confidence",
   ...
   * CN
   **/
  factory->add(NodeCreator("CN-archive-reader",
  ...
  factory->add(NodeCreator("CN-archive-writer", "Store CNs in archive.",
  ...
  factory->add(
      NodeCreator("state-cluster-CN-builder",
  ...
  factory->add(NodeCreator("cluster-CN-builder",
  ...
  factory->add(NodeCreator("pivot-CN-builder",
  ...
  factory->add(NodeCreator("center-frame-CN-builder",
                           "Build CN from incoming lattice(s).\n"
                           "The algorithm is based on finding an example or "
                           "prototype frame for each word.",
  ...
  factory->add(NodeCreator("frame-CN-builder",
  ...
  factory->add(
      NodeCreator("CN-gamma-correction",
                  "Perform a in-situ gamma correction of the slot-wise\n"
                  "posterior probability distribution.\n"
  ...
  factory->add(NodeCreator(
      "CN-combination", "Combine and decode incoming posterior CNs.",
  ...
  factory->add(
      NodeCreator("ROVER-combination", "Combine and decode incoming lattices.",
                  "[*.network.ROVER-combination]\n"
                  "type                        = ROVER-combination\n"
                  "cost                        = "
                  "sclite-word-cost|*sclite-time-mediated-cost\n"
                  "null-word                   = @\n"
                  "null-confidence             = 0.7\n"
                  "alpha                       = 0.0\n"
                  "posterior-key               = confidence\n"
                  ...
                  "  0:lattice [1:lattice [...]]\n"
                  "output:\n"
                  "  0:top-best-lattice 1:normalized-CN "
                  "2:normalized-CN-lattice 3:n-best-CN 4:n-best-CN-lattice",
  ...
  factory->add(NodeCreator(
      ...
      "cost                        = "
      "oracle-cost*|weighted-oracle-cost|oracle-loss\n"
  ...
  factory->add(NodeCreator(
      ...
      "- non-eps-slot:  Same as \"slot\", but slots containing only epsilon "
      "arcs\n"
      ...
      "                 lattice arcs pointing at these slots are set to "
      "epsilon.\n"
  ...
  factory->add(NodeCreator(
      ...
      "scorer                      = "
      "approximated-accuracy|continous-cost1|continous-cost2*|discrete-cost\n"
  ...
  factory->add(NodeCreator("approximated-risk-scorer",
  ...
  factory->add(NodeCreator("string-to-lattice",
