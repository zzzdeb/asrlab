...
protected:
  template <class T> void read(Input &i, T &v) const { i >> v; }

  template <class T> void write(Output &o, const T &v) const { o << v; }
...
public:
  StateTreeWriter(Bliss::LexiconRef lexicon,
...
protected:
  bool checkDependencies(const StateTree &tree, const std::string &filename,
                         Position) const;
