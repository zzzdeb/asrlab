...
private:
  ...
  /** Copies first nonDcLength_ number of samples into out and sets the start-
   * and end-time
   *  @return is false if the non DC segment is smaller than
   * minNonDcSegmentLength_.
   */
...
public:
   ...
   *
   *  remark: long non DC segments are delivered in blocks of length
   * maximalOutputSize_
   */
