...
/**
 ** \file ArithmeticExpressionParser.hh
 ** Define the BisonParser::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_BISONPARSER_ARITHMETICEXPRESSIONPARSER_HH_INCLUDED
#define YY_BISONPARSER_ARITHMETICEXPRESSIONPARSER_HH_INCLUDED
// //                    "%code requires" blocks.
#line 5 "ArithmeticExpressionParser.yy" // lalr1.cc:377
...
#define BISON_LOCATION_TYPE                                                    \
  BISON_NAMESPACE::ArithmeticExpressionParser::location_type
#define BISON_SEMANTIC_TYPE                                                    \
  BISON_NAMESPACE::ArithmeticExpressionParser::semantic_type
...
#line 111 "ArithmeticExpressionParser.hh" // lalr1.cc:377
...
#line 183 "ArithmeticExpressionParser.hh" // lalr1.cc:377
...
public:
  ...
  union semantic_type {
#line 79 "ArithmeticExpressionParser.yy" // lalr1.cc:377

    double fval;
    Core::ArithmeticExpressionParserDriver::MathFunc func;

#line 202 "ArithmeticExpressionParser.hh" // lalr1.cc:377
  };
#else
  ...
  /// Tokens.
  struct token {
    enum yytokentype { END = 0, FUNCTION = 258, NUMBER = 259, NEG = 261 };
  };
...
private:
  ...
  ArithmeticExpressionParser(const ArithmeticExpressionParser &);
  ArithmeticExpressionParser &operator=(const ArithmeticExpressionParser &);
...
#line 549 "ArithmeticExpressionParser.hh" // lalr1.cc:377

#endif // !YY_BISONPARSER_ARITHMETICEXPRESSIONPARSER_HH_INCLUDED
