...
const Core::Choice AcousticModelTrainer::choiceAction(
    "not-given", actionNotGiven, "dry", actionDryRun, "create-model-acceptors",
    actionCreateModelAcceptors, "show-mixture-set", actionShowMixtureSet,
    "convert-mixture-set", actionConvertMixtureSet, "cluster-mixture-set",
    actionClusterMixtureSet, "combine-mixture-sets", actionCombineMixtureSets,
    "map-adaptation", actionMapAdaptation, "combine-mixture-set-estimators",
    actionCombineMixtureSetEstimators, "map-mixture-set", actionMapMixtureSet,
    "accumulate-mixture-set-text-dependent",
    actionAccumulateMixtureSetTextDependent,
    "accumulate-mixture-set-text-independent",
    actionAccumulateMixtureSetTextIndependent, "accumulate-tdc-sum",
    actionAccumulateTdcSumFile, "combine-tdc-sums", actionCombineTdcSumFile,
    "accumulate-cart-examples", actionAccumulateCartExamples,
    "merge-cart-examples", actionMergeCartExamples, "estimate-cart",
    actionEstimateCart, "accumulate-discriminatively",
    actionAccumulateDiscriminatively,
    "convert-mixture-set-to-mixture-set-estimator",
    actionConvertMixtureSetToMixtureSetEstimator,
    "convert-mixture-set-to-log-linear-mixture-set",
    actionConvertMixtureSetToLogLinearMixtureSet, "score-features",
    actionScoreFeatures, "estimate-scatter-matrices-text-dependent",
    actionEstimateScatterMatricesTextDependent,
    "estimate-scatter-matrices-text-independent",
    actionEstimateScatterMatricesTextIndependent, "estimate-lda-text-dependent",
    actionEstimateLdaTextDependent, "estimate-lda-text-independent",
    actionEstimateLdaTextIndependent, "combine-lda",
    actionCombineScatterMatrixAccumulators,
    "combine-scatter-matrix-accumulators",
    actionCombineScatterMatrixAccumulators,
    "estimate-scatter-matrices-from-accumulator",
    actionEstimateScatterMatricesFromScatterMatrixAccumulator, "estimate-lda",
    actionEstimateLda, "estimate-affine-feature-transform",
    actionEstimateAffineFeatureTransform, "estimate-affine-feature-transform-2",
    actionEstimateAffineFeatureTransform2, "calculate-affine-feature-transform",
    actionCalculateAffineFeatureTransform,
    "calculate-affine-feature-transform-2",
    actionCalculateAffineFeatureTransform2,
    "combine-affine-feature-transform-estimators",
    ...
    "estimate-adaptation", actionEstimateModelTransform, "calculate-adaptation",
    actionCalculateModelTransform, "accumulate-maximum-entropy",
    actionAccumulateMaximumEntropy, "accumulate-combined-maximum-entropy",
    actionAccumulateCombinedMaximumEntropy,
    "accumulate-combined-exact-maximum-entropy",
    actionAccumulateCombinedExactMaximumEntropy, "combine-maximum-entropy",
    actionCombineMaximumEntropy, "estimate-maximum-entropy",
    actionEstimateMaximumEntropy, "center-maximum-entropy",
    actionCenterMaximumEntropy, "tie-maximum-entropy", actionTieMaximumEntropy,
...
const Core::ParameterChoice
    AcousticModelTrainer::paramAction("action", &choiceAction,
                                      "operation to perfom", actionNotGiven);

const Core::ParameterString paramActionName("action", "", "n/a");

const Core::ParameterStringVector
    AcousticModelTrainer::paramMixtureSetFilenamesToCombine(
        "mixture-set-files-to-combine",
        "name of mixture set file(s) to combine", " ", 1);

const Core::ParameterString
    AcousticModelTrainer::paramMappingFilenameToMap("mapping-file",
                                                    "name of mapping filename");

const Core::ParameterBool AcousticModelTrainer::paramForceExampleRegeneration(
    "force-example-regeneration",
    "force regeneration of the example file (equivalent to former .sum files) "
    "during Cart estimation yes/no",
    true);
...
int AcousticModelTrainer::main(const std::vector<std::string> &arguments) {
  ...
  case actionConvertMixtureSet:
    convertMixtureSet();
    break;
  case actionClusterMixtureSet:
    clusterMixtureSet();
    break;
  case actionCombineMixtureSets:
    combineMixtureSets();
    break;
  case actionMapAdaptation:
    mapAdaptation();
    break;
  ...
  case actionAccumulateMixtureSetTextIndependent:
    ...
    break;
  case actionAccumulateTdcSumFile:
    accumulateTdcSumFile();
    break;
  case actionCombineTdcSumFile:
    combineTdcSumFile();
    break;
  ...
  case actionEstimateCart:
    estimateCart();
    break;
  case actionAccumulateDiscriminatively:
    accumulateDiscriminatively();
    break;
  case actionConvertMixtureSetToMixtureSetEstimator:
    convertMixtureSetToMixtureSetEstimator();
    break;
  case actionConvertMixtureSetToLogLinearMixtureSet:
    convertMixtureSetToLogLinearMixtureSet();
    break;
  ...
  case actionEstimateAffineFeatureTransform:
    ...
    break;
  case actionEstimateAffineFeatureTransform2:
    estimateAffineFeatureTransform2();
    break;
  case actionCalculateAffineFeatureTransform:
    calculateAffineFeatureTransform();
    break;
  case actionCalculateAffineFeatureTransform2:
    calculateAffineFeatureTransform2();
    break;
  case actionScoreAffineFeatureTransform:
    scoreAffineFeatureTransform();
    break;
  case actionScoreAffineFeatureTransform2:
    scoreAffineFeatureTransform2();
    break;
  ...
  case actionCalculateModelTransform:
    ...
    break;
  case actionAccumulateMaximumEntropy:
    accumulateMaximumEntropy();
    break;
  case actionAccumulateCombinedMaximumEntropy:
    accumulateCombinedMaximumEntropy();
    break;
  case actionAccumulateCombinedExactMaximumEntropy:
    accumulateCombinedExactMaximumEntropy();
    break;
  case actionCombineMaximumEntropy:
    combineMaximumEntropy();
    break;
  case actionEstimateMaximumEntropy:
    estimateMaximumEntropy();
    break;
  case actionCenterMaximumEntropy:
    centerMaximumEntropy();
    break;
  case actionTieMaximumEntropy:
    tieMaximumEntropy();
    break;
  case actionAccumulateJoergfile:
    accumulateJoergfile();
    break;
  case actionAccumulateNearestNeighborTree:
    accumulateNearestNeighborTree();
    break;
  case actionAccumulatorConvert:
    accumulatorConvert();
    break;
  case actionAccumulateWeightHistogram:
    accumulateWeightHistogram();
    break;
  default:
...
void AcousticModelTrainer::createModelAcceptors() {
  Speech::AlignerModelAcceptorGenerator modelAcceptorGenerator(
      select("model-acceptor-generator"));
  visitCorpus(modelAcceptorGenerator);
}

void AcousticModelTrainer::showMixtureSet() {
  Speech::MixtureSetTrainer *trainer =
      Speech::Module::instance().createMixtureSetTrainer(
...
void AcousticModelTrainer::combineMixtureSets() {
  const Core::Configuration mixtureSetTrainerConfig =
      select("mixture-set-trainer");
  if (!Speech::MixtureSetTrainer::paramOldMixtureSetFilename(
           mixtureSetTrainerConfig, "")
           .empty())
  ...
  Speech::MixtureSetTrainer *trainer =
      Speech::Module::instance().createMixtureSetTrainer(
          mixtureSetTrainerConfig);
  trainer->combine(
      paramMixtureSetFilenamesToCombine(select("mixture-set-trainer")));
  delete trainer;
}
...
void AcousticModelTrainer::combineMixtureSetEstimators() {
  Speech::MixtureSetTrainer *trainer =
      Speech::Module::instance().createMixtureSetTrainer(
          select("mixture-set-trainer"));
  std::vector<std::string> toCombine =
      paramMixtureSetFilenamesToCombine(select("mixture-set-trainer"));
...
void AcousticModelTrainer::accumulateMixtureSetTextIndependent() {
  Speech::TextIndependentMixtureSetTrainer trainer(
      select("mixture-set-trainer"));
  visitCorpus(trainer);
  trainer.write();
}
...
void AcousticModelTrainer::combineTdcSumFile() {
  const Core::Configuration tdcSumEstimatorConfig =
      select("decision-tree-trainer");
  if (!Speech::TdcSumAccumulator::paramOldSumFile(tdcSumEstimatorConfig, "")
           .empty())
    Core::Application::us()->error("Old TDC sum file is ignored!");
  Speech::TdcSumAccumulator tdcSum(tdcSumEstimatorConfig);
  tdcSum.addSumFiles(
      Speech::TdcSumAccumulator::paramSumFilesToCombine(tdcSumEstimatorConfig));
  tdcSum.writeSumFile(
      Speech::TdcSumAccumulator::paramNewSumFile(tdcSumEstimatorConfig));
}
...
void AcousticModelTrainer::estimateCart() {
  ...
  if (!trainer.loadFromFile()) {
    criticalError(
        "unable to parse training file \"%s\"",
...
void AcousticModelTrainer::estimateScatterMatricesTextDependent() {
  Speech::TextDependentScatterMatricesEstimator estimator(
      select("scatter-matrices-estimator"));
  visitCorpus(estimator);
  estimator.getEstimator()->write();
}

void AcousticModelTrainer::estimateScatterMatricesTextIndependent() {
  Speech::TextIndependentScatterMatricesEstimator estimator(
      select("scatter-matrices-estimator"));
  visitCorpus(estimator);
  estimator.getEstimator()->write();
}
...
void AcousticModelTrainer::combineScatterMatrixAccumulators() {
  const Core::Configuration scatterMatricesEstimatorConfig =
      select("scatter-matrix-estimator");
  const Core::Configuration scatterMatricesEstimatorToCombineConfig =
      select("scatter-matrix-estimator-to-combine");

  Signal::ScatterMatricesEstimator estimator(scatterMatricesEstimatorConfig);
  if (!Signal::ScatterMatricesEstimator::paramOldAccumulatorFilename(
           scatterMatricesEstimatorToCombineConfig, "")
           .empty()) {
    // old scatter matrices accumulator combination syntax
    estimator.load();
    Signal::ScatterMatricesEstimator other(
        scatterMatricesEstimatorToCombineConfig);
    other.loadAccumulatorFile(
        Signal::ScatterMatricesEstimator::paramOldAccumulatorFilename(
            scatterMatricesEstimatorToCombineConfig));
    estimator.accumulate(other);
  } else {
    if (!Signal::ScatterMatricesEstimator::paramOldAccumulatorFilename(
             scatterMatricesEstimatorConfig, "")
             .empty())
      Core::Application::us()->error(
          "Old scatter accumulator file is ignored!");
    // multiple accumulator combination syntax
    estimator.addAccumulatorFiles(
        Signal::ScatterMatricesEstimator::paramAccumulatorFilesToCombine(
            scatterMatricesEstimatorConfig));
  }
  estimator.write();
}

void AcousticModelTrainer::
    estimateScatterMatricesFromScatterMatrixAccumulator() {
  Signal::ScatterMatricesEstimator estimator(
      select("scatter-matrix-estimator"));
  estimator.load();
  /*
...
#ifdef MODULE_ADAPT_CMLLR
  Speech::AffineFeatureTransformEstimator estimator(
      select("affine-feature-transform-estimator"));
  visitCorpus(estimator);
...
void AcousticModelTrainer::calculateAffineFeatureTransform() {
  ...
  Speech::AffineFeatureTransformEstimator estimator(
      select("affine-feature-transform-estimator"),
      Speech::AffineFeatureTransformEstimator::calculate);
  estimator.postProcess();
#endif
}
...
void AcousticModelTrainer::combineAffineFeatureTransformEstimators() {
  ...
  Speech::AffineFeatureTransformEstimator estimator(
      select("affine-feature-transform-estimator"),
      Speech::AffineFeatureTransformEstimator::combines);
  estimator.combine();
  estimator.postProcess();
#endif
}
...
void AcousticModelTrainer::scoreAffineFeatureTransform2() {
  ...
  // Speech::FmpeGradientEstimator
  // estimator(select("affine-feature-transform-estimator-2"));
  // estimator.scoreTransforms();
}
...
#ifdef MODULE_ADAPT_MLLR
  Speech::ModelTransformEstimator estimator(
      select("adaptation-estimator"),
...
#if 1
  criticalError(
      "Modules MM_ADVANCED, SIGNAL_ADVANCED, ME, SPARSE are not available");
#endif
}
...
void AcousticModelTrainer::visitCorpus(
    Speech::CorpusProcessor &corpusProcessor) {
...
void AcousticModelTrainer::visitCorpus(
    Speech::AlignedFeatureProcessor &alignedFeatureProcessor) {
...
void AcousticModelTrainer::visitCorpus(
    Speech::LabeledFeatureProcessor &labeledFeatureProcessor) {
  Speech::LabelingFeatureExtractor labelingFeatureExtractor(
      select("labeling"), labeledFeatureProcessor);
  visitCorpus(labelingFeatureExtractor);
}

void AcousticModelTrainer::visitCorpus(
    Core::Ref<Speech::LatticeSetProcessor> latticeSetProcessor) {
#if 1
