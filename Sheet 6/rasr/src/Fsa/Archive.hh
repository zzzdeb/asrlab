...
public:
  Archive(const Core::Configuration &config, const std::string &pathname,
...
public:
  ArchiveReader(const Core::Configuration &config, const std::string &pathname);
  ArchiveReader(const Core::Configuration &config);
...
public:
  ArchiveWriter(const Core::Configuration &config, const std::string &pathname,
                ConstAlphabetRef inputAlphabet,
                ConstAlphabetRef outputAlphabet = ConstAlphabetRef());
  ArchiveWriter(const Core::Configuration &config,
                ConstAlphabetRef inputAlphabet,
                ConstAlphabetRef outputAlphabet = ConstAlphabetRef());
