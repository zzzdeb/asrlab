 ...
 */
template <typename T> class NameHelper : public std::string {
public:
  NameHelper() : std::string(Type<T>::name) {}
};

template <> class NameHelper<std::string> : public std::string {
public:
  NameHelper() : std::string("string") {}
};

template <> class NameHelper<bool> : public std::string {
public:
  NameHelper() : std::string("bool") {}
};

template <typename T> class NameHelper<std::complex<T> > : public std::string {
public:
  NameHelper() : std::string(std::string("complex-") + NameHelper<T>()) {}
};

template <typename T> class NameHelper<std::vector<T> > : public std::string {
public:
 ...
 */
template <size_t size> void swapEndianess(void *buf, size_t count = 1);
template <> inline void swapEndianess<1>(void *buf, size_t count) {}
...
template <>
inline bool equal(std::vector<u8>::const_iterator b1,
                  std::vector<u8>::const_iterator e1,
                  std::vector<u8>::const_iterator b2) {
  return (memcmp(&(*b1), &(*b2), sizeof(u8) * (e1 - b1)) == 0);
}
template <>
inline bool equal(std::vector<s8>::const_iterator b1,
                  std::vector<s8>::const_iterator e1,
                  std::vector<s8>::const_iterator b2) {
  return (memcmp(&(*b1), &(*b2), sizeof(s8) * (e1 - b1)) == 0);
}

template <>
inline bool equal(std::vector<u16>::const_iterator b1,
                  std::vector<u16>::const_iterator e1,
                  std::vector<u16>::const_iterator b2) {
  return (memcmp(&(*b1), &(*b2), sizeof(u16) * (e1 - b1)) == 0);
}
template <>
inline bool equal(std::vector<s16>::const_iterator b1,
                  std::vector<s16>::const_iterator e1,
                  std::vector<s16>::const_iterator b2) {
  return (memcmp(&(*b1), &(*b2), sizeof(s16) * (e1 - b1)) == 0);
}

template <>
inline bool equal(std::vector<u32>::const_iterator b1,
                  std::vector<u32>::const_iterator e1,
                  std::vector<u32>::const_iterator b2) {
  return (memcmp(&(*b1), &(*b2), sizeof(u32) * (e1 - b1)) == 0);
}
template <>
inline bool equal(std::vector<s32>::const_iterator b1,
                  std::vector<s32>::const_iterator e1,
                  std::vector<s32>::const_iterator b2) {
