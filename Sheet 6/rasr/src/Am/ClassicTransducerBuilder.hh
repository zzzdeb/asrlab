...
private: // internal
  ...
  typedef Core::hash_map<PhoneBoundaryStateDescriptor, Fsa::State *,
  ...
  struct AllophoneSuffix {
    ...
    struct Equality {
      ...
      bool operator()(const AllophoneSuffix &l,
                      const AllophoneSuffix &r) const {
  ...
  typedef Core::hash_map<AllophoneSuffix, Fsa::StateId, AllophoneSuffix::Hash,
                         AllophoneSuffix::Equality>
      AllophoneSuffixMap;
  ...
  void buildAllophoneStates(const Allophone *, Fsa::State *start,
                            Fsa::State *end);
  void buildWordBoundaryLinks(Fsa::State *, Fsa::State *);
  void createEmptyTransducer();
  void buildPhoneLoop();
  Fsa::State *buildSilenceAndNoiseLoops(const Bliss::PhonemeInventory &,
                                        const Phonology &, Fsa::State *);
...
public:
  ...
  /**
   * Apply transition model to a flat automaton, i.e. add loop and skip
   * transitions.
   */
  ...
  createEmissionLoopTransducer(bool transitionModel);
