...
protected:
  ...
  bool isTokenMapped(Token t) const { return tokenMap_[t] != invalidClass; }
  void finalizeMapping();

  InternalClassIndex nInternalClasses() const { return nInternalClasses_; }

  InternalClassIndex internalClassIndex(Token t) const { return tokenMap_[t]; }
