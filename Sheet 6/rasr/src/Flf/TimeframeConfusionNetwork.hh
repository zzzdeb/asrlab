...
public:
  ...
  */
  ...
  /*
    ...
    - some experiments with normalization dependency on word label, e.g. words
    vs. non-words; not implemented yet
  */
  static Score smooth(Score error, Score duration, Score alpha = 0.05);
};

ConstLatticeRef
extendByFCnConfidence(ConstLatticeRef l, ConstPosteriorCnRef cn, ScoreId id,
