...
public:
  ...
  AbstractParameter(const char *ident, const char abbrev,
  ...
  bool operator<(const AbstractParameter &p) const { return (ident < p.ident); }
...
protected:
  ...
  Value getValue(const class Configuration &c,
...
public:
  virtual bool isValid(const Value &v) const { return true; }

  Parameter(const char *ident, const char *s_desc, const Value &defaultValue,
            const char *l_desc = "");
   ...
   */
  Value operator()(const class Configuration &c,
                   const Value &_defaultValue) const {
   ...
   */
  Value operator()(const class Configuration &c) const { return getValue(c); }
};

/**
 * Base class template for multiple-choice parameters.
 */
template <class T> class AbstractChoiceParameter : public Parameter<T> {
public:
  typedef T Value;
  ...
  AbstractChoiceParameter(const char *ident, const char *s_desc,
 ...
 **/
template <class T> class RangedParameter : public Parameter<T> {
public:
  typedef T Value;
...
public:
  ...
  RangedParameter(const char *ident, const char *s_desc,
                  const Value &defaultValue, const Value &minValue,
...
public:
  ...
  ParameterBool(const char *ident, const char *s_desc,
                const bool defaultValue = false, const char *l_desc = "");
};
...
public:
  virtual void printParseHelp(std::ostream &os) const;
  virtual bool parseString(const std::string &in, Value &out) const;
  ParameterInt(const char *ident, const char *s_desc, s32 defaultValue = 0,
               s32 minValue = Core::Type<s32>::min,
               s32 maxValue = Core::Type<s32>::max, const char *l_desc = "");
};
...
public:
  virtual void printParseHelp(std::ostream &os) const;
  virtual bool parseString(const std::string &in, Value &out) const;
  ParameterFloat(const char *ident, const char *s_desc, f64 defaultValue = 0.0,
                 f64 minValue = Core::Type<f64>::min,
                 f64 maxValue = Core::Type<f64>::max, const char *l_desc = "");
};
...
public:
  ...
  ParameterChoice(const char *ident, const Choice *c, const char *s_desc,
                  const s32 defaultValue = 0, const char *l_desc = "");
};
...
public:
  virtual bool parseString(const std::string &in, Value &out) const;
  ParameterString(const char *ident, const char *s_desc,
...
public:
  ...
  ParameterBitVector(const char *ident, const char *s_desc,
 ...
 */
template <class T> class VectorParameter : public AbstractParameter {
public:
  typedef T Value;
  typedef u32 Size;
...
public:
  ...
  VectorParameter(const char *ident, const char *s_desc,
   ...
   */
  Vector operator()(const class Configuration &c) const { return getVector(c); }
};
...
public:
  ParameterStringVector(const char *ident, const char *s_desc,
                        const std::string delimiter = "",
                        const Size minSize = Core::Type<Size>::min,
                        const Size maxSize = Core::Type<Size>::max,
                        const char *l_desc = "");
...
public:
  ParameterIntVector(const char *ident, const char *s_desc,
                     const std::string delimiter = "",
...
public:
  ParameterFloatVector(const char *ident, const char *s_desc,
                       const std::string delimiter = "",
...
public:
  ParameterWeightVector(const char *ident, const char *s_desc,
                        const std::string delimiter = "",
