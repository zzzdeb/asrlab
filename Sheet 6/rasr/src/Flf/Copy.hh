 ...
 * - l is traversed exactly once, i.e. getState is called exactly once for every
 *accessible state Behaviour of std::pair<bool,bool> copyXXX(ConstLatticeRef l,
 *                                           StaticLattice *staticLattice,
 *                                           StaticBoundaries
 **staticBoundaries);
 * - staticLattice and staticBoundaries are cleared; the boundaries object of
 *staticLattice is not touched
 * - if !l then (false,false) is returned
 * - else if boundaries of l are invalid or staticBoundaries is null, then
 ...
 * Copy:
 *  Copy states, make weights persistent, i.e. states are copied, but not the
 *weights
 ...
 * - l is traversed exactly once and only boundaries associated with accessible
 *states are copied Behaviour of bool copyBoundaries(ConstLatticeRef l,
 *                                  StaticBoundaries *staticBoundaries);
 ...
 * - the boundaries of l are copied and set at l and l is returned, i.e. l is
 *modified!
 **/
