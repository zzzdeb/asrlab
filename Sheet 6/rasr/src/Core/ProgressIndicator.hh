...
public:
  WithProgressIndicator(const std::string &task = "",
                        const std::string &unit = "")
      : progress_(task, unit) {}
  void setTask(const std::string &task,
               ProgressIndicator::Alignment align) const {
...
public:
  WithoutProgressIndicator(const std::string &task = "",
                           const std::string &unit = "") {}
  void setTask(const std::string &task,
               ProgressIndicator::Alignment align) const {}
