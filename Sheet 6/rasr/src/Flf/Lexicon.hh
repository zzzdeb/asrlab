...
public:
  ...
  typedef Core::Ref<const Bliss::LemmaPronunciationAlphabet>
      LemmaPronunciationAlphabetRef;
  typedef Core::Ref<const Bliss::SyntacticTokenAlphabet>
      SyntacticTokenAlphabetRef;
  typedef Core::Ref<const Bliss::EvaluationTokenAlphabet>
      EvaluationTokenAlphabetRef;

  typedef std::vector<const Bliss::Lemma *> ConstLemmaPtrList;
  typedef std::vector<const Bliss::LemmaPronunciation *>
      ConstLemmaPronunciationPtrList;
  ...
  /**
   * Map an Fsa alphabet to one of the lexicon's alphabets; insert symbols if
   *necessary
   **/
  class AlphabetMap : public Core::Vector<Fsa::LabelId>,
  ...
  typedef Core::Ref<const Bliss::PhonemeToLemmaPronunciationTransducer>
      PhonemeToLemmaPronunciationTransducerRef;
  typedef Core::Ref<const Bliss::LemmaPronunciationToLemmaTransducer>
      LemmaPronunciationToLemmaTransducerRef;
  typedef Core::Ref<const Bliss::LemmaToSyntacticTokenTransducer>
      LemmaToSyntacticTokenTransducerRef;
  typedef Core::Ref<const Bliss::LemmaToEvaluationTokenTransducer>
      LemmaToEvaluationTokenTransducerRef;

private:
  Fsa::ConstAlphabetRef unknownAlphabet_;
  Bliss::PhonemeInventory *phonemeInventory_;
  typedef Core::hash_map<std::string, Bliss::Lemma *, Core::StringHash,
                         Core::StringEquality>
      LemmaMap;
...
public:
  ...
  */
  ...
  const Bliss::LemmaPronunciation *lemmaPronunciation(const Bliss::Lemma *,
                                                      s32 variant);
  std::pair<const Bliss::Lemma *, s32>
  lemmaPronunciationVariant(const Bliss::LemmaPronunciation *);
  ...
  */
  ...
  AlphabetId alphabetId(Fsa::ConstAlphabetRef alphabet,
  ...
  */
  PhonemeToLemmaPronunciationTransducerRef
  phonemeToLemmaPronunciationTransducer();
...
public:
  EditDistance(Fsa::ConstAlphabetRef alphabet,
