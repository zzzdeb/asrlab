...
typedef Lattice::CachedAcousticAccumulator<DiscriminativeMixtureSetTrainer>
    GmmAccumulator;
...
class SegmentwiseGmmTrainer
    : public AcousticSegmentwiseTrainer<GmmAccumulator> {
 ...
 * see Heigold et.al., Modified MMI/MPE, ICML 2008, for a description of the
 * transducer based gradient accumulation
 *
 */
