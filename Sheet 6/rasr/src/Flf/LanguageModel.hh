 ...
 * LanguageModelRescorer.hh; a slight difference concers the
 *syntax-emission-probabilities (see the comments in Compose.cc).
 *
 * Additional features:
 * - the result of the composition has exactly as many final states as the input
 *lattice
 **/

ConstLatticeRef composeWithLm(ConstLatticeRef l, ConstLanguageModelRef lm,
                              ScoreId id, Score scale = Semiring::DefaultScale,
                              bool forceSentenceEnd = false);
