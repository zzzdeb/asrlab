...
public:
  ...
  Cluster(const DecisionTree::Node *node, ConstExampleRefList *exampleRefs)
      : node(node), exampleRefs(exampleRefs) {}
  ~Cluster() { delete exampleRefs; }
