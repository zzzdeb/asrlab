...
Flf::ConstLatticeRef changeSemiring(Flf::ConstLatticeRef l,
                                    Flf::ConstSemiringRef semiring);
void cheapInfo(Flf::ConstLatticeRef l, Core::XmlWriter &o);
Flf::ConstLatticeRef composeMatching(Flf::ConstLatticeRef l,
                                     Flf::ConstLatticeRef r);
Flf::ConstLatticeRef composeSequencing(Flf::ConstLatticeRef l,
                                       Flf::ConstLatticeRef r);
Fsa::AutomatonCounts count(Flf::ConstLatticeRef l, bool progress);
size_t countInput(Flf::ConstLatticeRef l, Fsa::LabelId label,
                  bool progress = false);
size_t countOutput(Flf::ConstLatticeRef l, Fsa::LabelId label,
                   bool progress = false);
Flf::ConstLatticeRef determinize(Flf::ConstLatticeRef l,
...
Fsa::Property getProperties(Flf::ConstLatticeRef l,
                            Fsa::Property properties = Fsa::PropertyAll);
void info(Flf::ConstLatticeRef l, Core::XmlWriter &o, bool progress = false);
...
Flf::ConstLatticeRef mapInput(Flf::ConstLatticeRef l,
                              const Fsa::AlphabetMapping &m);
Flf::ConstLatticeRef mapInputOutput(Flf::ConstLatticeRef l,
                                    const Fsa::AlphabetMapping &m);
Flf::ConstLatticeRef mapOutput(Flf::ConstLatticeRef l,
                               const Fsa::AlphabetMapping &m);
...
Flf::ConstLatticeRef nbest(Flf::ConstLatticeRef l, size_t n = 1,
