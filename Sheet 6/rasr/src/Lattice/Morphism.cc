...
MorphismAutomaton::MorphismAutomaton(
    Fsa::ConstAutomatonRef fsa, Core::Ref<WordBoundaries> mappedWordBoundaries)
    : Fsa::SlaveAutomaton(fsa), mappedWordBoundaries_(mappedWordBoundaries) {}
...
public:
  UnaryMorphismAutomaton(Fsa::ConstAutomatonRef,
                         Core::Ref<const WordBoundaries>, Fsa::ConstMappingRef,
...
UnaryMorphismAutomaton::UnaryMorphismAutomaton(
    Fsa::ConstAutomatonRef fsa, Core::Ref<const WordBoundaries> wordBoundaries,
    Fsa::ConstMappingRef morphism,
    Core::Ref<WordBoundaries> mappedWordBoundaries)
    : Precursor(fsa, mappedWordBoundaries), wordBoundaries_(wordBoundaries),
      morphism_(morphism) {}
...
ConstWordLatticeRef
resolveMorphism(ConstWordLatticeRef l,
...
Fsa::ConstStateRef NaryMorphismAutomaton::getState(Fsa::StateId s) const {
  if ((s >= mappedWordBoundaries_->size()) or
      !(*mappedWordBoundaries_)[s].valid()) {
