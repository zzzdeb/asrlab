...
public:
  virtual ~Datatype() {}
  inline bool operator<(const Datatype &d) const { return name_ < d.name_; }
...
protected:
  void brand(Data *d) const { verify(d->datatype_ == this); }
...
template <class T> class DatatypeTemplate : public Datatype {
public:
