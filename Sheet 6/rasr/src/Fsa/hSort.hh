...
struct byArc : public std::binary_function<typename _Automaton::Arc,
                                           typename _Automaton::Arc, bool> {
  typename _Automaton::ConstSemiringRef semiring_;
  byArc(typename _Automaton::ConstSemiringRef semiring) : semiring_(semiring) {}
  bool operator()(const typename _Automaton::Arc &a,
                  const typename _Automaton::Arc &b) const {
    if (a.input() < b.input())
      return true;
    if (a.input() > b.input())
      return false;
...
template <class _Automaton>
struct byInput : public std::binary_function<typename _Automaton::Arc,
                                             typename _Automaton::Arc, bool> {
  bool operator()(const typename _Automaton::Arc &a,
                  const typename _Automaton::Arc &b) const {
...
template <class _Automaton>
struct byOutput : public std::binary_function<typename _Automaton::Arc,
                                              typename _Automaton::Arc, bool> {
  bool operator()(const typename _Automaton::Arc &a,
                  const typename _Automaton::Arc &b) const {
...
struct byInputAndTarget
    : public std::binary_function<typename _Automaton::Arc,
                                  typename _Automaton::Arc, bool> {
  bool operator()(const typename _Automaton::Arc &a,
                  const typename _Automaton::Arc &b) const {
    if (a.input() < b.input())
...
template <class _Automaton>
struct byWeight : public std::binary_function<typename _Automaton::Arc,
                                              typename _Automaton::Arc, bool> {
  typename _Automaton::ConstSemiringRef semiring_;
