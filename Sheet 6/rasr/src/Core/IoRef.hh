 ...
 */
template <class Base> class IoRef : public Ref<Base> {
public:
...
private:
  ...
  template <class Derived> static Base *creator0_() { return new Derived(); }
  template <class Derived, class T> static Base *creator1_() {
    return new Derived(arg1_<Derived, T>());
  }
  template <class Derived, class T1, class T2> static Base *creator2_() {
    return new Derived(arg1_<Derived, T1>(), arg2_<Derived, T2>());
  }

  template <typename Derived, typename T> static T &arg1_() {
    static T arg;
    return arg;
  }
  template <typename Derived, typename T> static T &arg2_() {
    static T arg;
    return arg;
  }
...
public:
  ...
  static void registerClass(const T1 &arg1, const T2 &arg2) {
    ...
    creators_()[((Derived *)0)->Derived::typeName()] =
        creator2_<Derived, T1, T2>;
  }
