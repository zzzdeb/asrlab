...
/*
 * single-pass SCC algorithm from "graphs and their representations in a
 *computer", chapter 4, Mehlhorn, 1999 modifed to fit into DFS algorithm from
 *Cormen et al., see also Dfs.cc
 **/
