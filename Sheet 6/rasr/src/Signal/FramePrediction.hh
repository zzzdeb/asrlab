...
/** FramePredictionNode: creates one elements for each elements read from
 * "target" stream by prediction for target start-times
 *
...
template <class Algorithm>
FramePredictionNode<Algorithm>::FramePredictionNode(
