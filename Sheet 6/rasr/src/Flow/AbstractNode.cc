...
const Core::ParameterBool
    AbstractNode::paramThreaded("threaded", "enable separeted thread for node",
                                false);
const Core::ParameterBool AbstractNode::paramIgnoreUnknownParameters(
    "ignore-unknown-parameters",
    "Controls if error is generated when setting the value of unknown "
    "parameters.",
    false);
/*****************************************************************************/
...
/***************************************************************************************/
bool AbstractNode::checkAndSetParameter(const std::string &name,
...
/***************************************************************************************/
bool AbstractNode::addParameter(const std::string &name,
...
/*****************************************************************************/
void AbstractNode::addUnresolvedParameter(const std::string &key,
                                          const std::string &value)
/*****************************************************************************/
{
...
/*****************************************************************************/
const AbstractNode::UnresolvedAttributes &
AbstractNode::unresolvedAttributes() const
/*****************************************************************************/
{
