 ...
 *    => returned SlaveAutomaton has new alphabet but does not actually do
 * anything
 * 3. Mapping is partial identity (surjective) (same indices, but some symbols
 * missing but)
 ...
 **/
template <class _Automaton>
typename _Automaton::ConstRef mapInputOutput(typename _Automaton::ConstRef,
                                             const Fsa::AlphabetMapping &);
} // namespace Ftl
