 ...
 * of its element; if false timestamp of the "present" element is copied to
...
template <class T>
VectorSequenceAggregation<T>::VectorSequenceAggregation(
...
template <class T>
bool VectorSequenceAggregation<T>::setParameter(const std::string &name,
...
template <class T> bool VectorSequenceAggregation<T>::putData() {
  ...
  Flow::TypedAggregate<DataType> *out =
      new Flow::TypedAggregate<DataType>(inputData);
