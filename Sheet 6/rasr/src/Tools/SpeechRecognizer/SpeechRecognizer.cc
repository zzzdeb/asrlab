...
const Core::Choice SpeechRecognizer::recognitionModeChoice(
    "offline", offlineRecognition, "delayed", offlineDelayedRecognition,
    "rescore", offlineLmRescoring, "online", onlineRecognition, "phonemes",
    offlinePhonemeRecognition, "decode-phonemes", offlinePhonemeDecoding,
    "constrained", offlineConstrainedRecognition, "offline-sign-language",
    offlineSignLanguageRecognition, "directory", offlineDirectoryVisitor,
    Core::Choice::endMark());
const Core::ParameterChoice SpeechRecognizer::paramRecognitionMode(
    "recognition-mode", &recognitionModeChoice,
    "operation mode: corpus-base (offline) or online", offlineRecognition);
