...
public:
  ...
  virtual void processAlignedFeature(Core::Ref<const Feature> f,
                                     Am::AllophoneStateIndex id, Mm::Weight w);
...
public:
  ...
  public:
    ...
    Cart::Score logLikelihood(Cart::ExamplePtrList::const_iterator begin,
                              Cart::ExamplePtrList::const_iterator end) const;

    // compute a gain, not a distance, i.e. the higher the return score, the
    // better
    Cart::Score operator()(const Cart::ExamplePtrRange &leftExamples,
                           const Cart::ExamplePtrRange &rightExamples,
                           const Cart::Score fatherLogLikelihood,
                           Cart::Score &leftChildLogLikelihood,
                           Cart::Score &rightChildLogLikelihood) const;
    void operator()(const Cart::ExamplePtrRange &examples,
