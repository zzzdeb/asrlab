...
namespace Fsa {
ConstAutomatonRef mapInput(ConstAutomatonRef f, ConstAlphabetRef a,
                           u32 reportUnknowns) {
  return Ftl::mapInput<Automaton>(f, a, reportUnknowns);
}

ConstAutomatonRef mapOutput(ConstAutomatonRef f, ConstAlphabetRef a,
                            u32 reportUnknowns) {
  return Ftl::mapOutput<Automaton>(f, a, reportUnknowns);
}

ConstAutomatonRef mapInputOutput(ConstAutomatonRef f, ConstAlphabetRef a,
                                 u32 reportUnknowns) {
...
ConstAutomatonRef mapInputOutput(ConstAutomatonRef f,
                                 const AlphabetMapping &m) {
...
ConstAutomatonRef partial(ConstAutomatonRef f,
                          StateId initialStateOfPartialAutomaton) {
  return Ftl::partial<Automaton>(f, initialStateOfPartialAutomaton);
}

ConstAutomatonRef partial(ConstAutomatonRef f,
                          StateId initialStateOfPartialAutomaton,
                          Weight additionalFinalWeight) {
  return Ftl::partial<Automaton>(f, initialStateOfPartialAutomaton,
                                 additionalFinalWeight);
}
...
ConstAutomatonRef changeSemiring(ConstAutomatonRef f,
...
bool isEmpty(ConstAutomatonRef f) { return Ftl::isEmpty<Automaton>(f); }
