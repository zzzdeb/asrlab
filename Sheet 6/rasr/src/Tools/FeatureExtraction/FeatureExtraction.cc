...
const Core::Choice ExtractionApplication::choiceFormat("none", noFormat,
                                                       "sietill", sietillFormat,
                                                       "mm2", mm2Format,
                                                       Core::Choice::endMark());

const Core::ParameterChoice
    ExtractionApplication::paramFormat("feature-format", &choiceFormat,
                                       "file format for generated features",
                                       noFormat);

const Core::ParameterBool
    ExtractionApplication::paramVerbose("verbose", "verbose mode", false);
