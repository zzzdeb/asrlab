...
StatePotentials sssp(ConstAutomatonRef f, StateId start,
                     const SsspArcFilter &arcFilter = SsspArcFilter(),
                     bool progress = false);
...
ConstAutomatonRef posterior64(ConstAutomatonRef f, Weight &totalInv,
                              s32 tol = 100);
ConstAutomatonRef posterior64(ConstAutomatonRef f, f64 &totalInv,
                              s32 tol = 100);
ConstAutomatonRef posterior64(ConstAutomatonRef f, Weight &total,
                              bool normalize, s32 tol = 100);

void ssspE(ConstAutomatonRef, ConstAutomatonRef, StatePotentials64 &,
           StatePotentials64 &);
...
ConstAutomatonRef posteriorE(ConstAutomatonRef f, ConstAutomatonRef r,
                             Weight &expectation, bool vNormalized = true,
                             s32 tol = 100);
/*
