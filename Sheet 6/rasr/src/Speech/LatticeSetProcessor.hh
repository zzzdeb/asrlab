...
public:
  ...
  /** Override this function to perform pre processing before the first segment
   * of the corpus.
   */
  ...
  /** Override this function to perform post processing after the last segment
   * of the corpus.
   */
  ...
  /** Override this function to perform preparations before first aligned
   * features arrive.
   */
  ...
  /** Override this function to perform post processing after the last aligned
  ...
  /** Override this function to perform preparations before first features
   * arrive.
   */
  ...
  /** Override this function to perform post processing after the last features
   * of the segment.
   */
   ...
   */
  virtual void processWordLattice(Lattice::ConstWordLatticeRef,
                                  Bliss::SpeechSegment *);
  /**
   *  Override this function to create the description of the output word
   * lattices.
   */
   ...
   */
  virtual void
  setWordLatticeDescription(const Lattice::WordLatticeDescription &) {}
  ...
  virtual void
      setSegmentwiseFeatureExtractor(Core::Ref<SegmentwiseFeatureExtractor>);
  virtual void
      setAlignmentGenerator(Core::Ref<PhonemeSequenceAlignmentGenerator>);
};
