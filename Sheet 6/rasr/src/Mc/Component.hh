...
class ScaleUpdate {
private:
  class ScaleMap : public Core::StringHashMap<Scale>,
...
public:
   ...
   *  If @param update object does not contain new scale for this object, old
   * one is kept. Passes the modified update to the child objects.
   */
