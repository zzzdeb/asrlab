...
typename _Automaton::ConstRef identity(Fsa::ConstAlphabetRef,
...
template <class _Automaton>
typename _Automaton::ConstRef concat(typename _Automaton::ConstRef,
                                     typename _Automaton::ConstRef);
template <class _Automaton>
typename _Automaton::ConstRef
...
template <class _Automaton>
typename _Automaton::ConstRef unite(typename _Automaton::ConstRef,
                                    typename _Automaton::ConstRef);
/**
...
template <class _Automaton>
typename _Automaton::ConstRef fuse(typename _Automaton::ConstRef,
                                   typename _Automaton::ConstRef);
