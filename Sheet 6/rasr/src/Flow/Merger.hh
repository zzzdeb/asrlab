...
template <class I, class O> class MergerNode : public CollectorNode<I, O> {
...
template <class I, class O>
bool MergerNode<I, O>::setParameter(const std::string &name,
                                    const std::string &value) {
  return Precursor::setParameter(name, value);
}

template <class I, class O> bool MergerNode<I, O>::configure() {
  if (!Precursor::configure())
    return false;
  return true;
}

template <class I, class O> bool MergerNode<I, O>::work(Flow::PortId p) {
