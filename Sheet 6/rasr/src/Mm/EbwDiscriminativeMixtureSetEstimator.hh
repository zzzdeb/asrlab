...
protected:
  ...
  virtual EbwDiscriminativeGaussDensityEstimator *
  createDensityEstimator(const GaussDensity &);
  ...
  virtual EbwDiscriminativeCovarianceEstimator *
  createCovarianceEstimator(const Covariance &);

  virtual EbwDiscriminativeMixtureEstimator &
  mixtureEstimator(MixtureIndex mixture) {
  ...
  virtual void initialize(const MixtureSetEstimatorIndexMap &,
...
protected:
  ...
  createMixtureEstimator();
  virtual EbwDiscriminativeGaussDensityEstimatorWithISmoothing *
  createDensityEstimator();
  virtual EbwDiscriminativeGaussDensityEstimatorWithISmoothing *
  createDensityEstimator(const GaussDensity &);
  virtual EbwDiscriminativeMeanEstimatorWithISmoothing *createMeanEstimator();
  virtual EbwDiscriminativeMeanEstimatorWithISmoothing *
  createMeanEstimator(const Mean &);
  ...
  virtual void load();
  virtual void finalize(MixtureSet &, const MixtureSetEstimatorIndexMap &,
                        const CovarianceToMeanSetMap &);
  virtual void setIMixture(Core::Ref<AbstractMixtureEstimator>, const Mixture *,
                           Weight iSmoothing);
  virtual void setIDensity(Core::Ref<GaussDensityEstimator>,
                           const GaussDensity *);
  virtual void setIMean(Core::Ref<AbstractMeanEstimator>, const Mean *,
                        Weight iSmoothing);
  virtual void setICovariance(Core::Ref<AbstractCovarianceEstimator>,
                              const Covariance *, Weight iSmoothing);
  virtual Weight
  getMixtureObjectiveFunction(Core::Ref<AbstractMixtureEstimator> estimator) {
    return required_cast(EbwDiscriminativeMixtureEstimatorWithISmoothing *,
                         estimator.get())
        ->getObjectiveFunction();
  }
  virtual Weight getCovarianceObjectiveFunction(
      Core::Ref<AbstractCovarianceEstimator> estimator,
      const CovarianceToMeanSetMap &meanSetMap) {
    return required_cast(EbwDiscriminativeCovarianceEstimatorWithISmoothing *,
                         estimator.get())
        ->getObjectiveFunction(meanSetMap);
  }
