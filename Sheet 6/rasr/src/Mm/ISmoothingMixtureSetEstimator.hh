...
protected:
  virtual void setIMixture(Core::Ref<AbstractMixtureEstimator> estimator,
                           const Mixture *mixture, Weight iSmoothing) = 0;
  virtual void setIDensity(Core::Ref<GaussDensityEstimator> estimator,
                           const GaussDensity *density) = 0;
  virtual void setIMean(Core::Ref<AbstractMeanEstimator> estimator,
                        const Mean *mean, Weight iSmoothing) = 0;
  virtual void setICovariance(Core::Ref<AbstractCovarianceEstimator> estimator,
                              const Covariance *covariance,
                              Weight iSmoothing) = 0;
  virtual Weight
      getMixtureObjectiveFunction(Core::Ref<AbstractMixtureEstimator>) = 0;
  virtual Weight
  getCovarianceObjectiveFunction(Core::Ref<AbstractCovarianceEstimator>,
...
public:
  ...
  Sum getObjectiveFunction(const MixtureSet &,
