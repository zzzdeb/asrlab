...
public:
  ...
  void set(Core::Ref<const Bliss::PhonemeInventory>, u32 contextLength,
           u32 nStates);
...
public:
  ...
  EmissionToPhonemeTransducer(u32 nMixtures,
                              Core::Ref<const Bliss::PhonemeAlphabet>);
  ...
  const Bliss::PhonemeAlphabet *phonemeAlphabet() const {
    return dynamic_cast<const Bliss::PhonemeAlphabet *>(
        getOutputAlphabet().get());
  }
};
...
public:
  ...
  const AllophoneStateAlphabet *allophoneStateAlphabet() const {
    return dynamic_cast<const AllophoneStateAlphabet *>(
        getInputAlphabet().get());
  }
  const Bliss::PhonemeAlphabet *phonemeAlphabet() const {
    return dynamic_cast<const Bliss::PhonemeAlphabet *>(
        getOutputAlphabet().get());
...
private:
  typedef Core::HashMap<AllophoneStateAlphabet::Index, Mm::MixtureIndex>
      CacheMap;
...
public:
  ...
  virtual Mm::MixtureIndex
  classifyIndex(AllophoneStateAlphabet::Index index) const {
...
public:
  ...
  virtual Mm::MixtureIndex nClasses() const { return alphabet_.nClasses(); }
  virtual Mm::MixtureIndex
  classifyIndex(AllophoneStateAlphabet::Index i) const {
    return i;
  }
