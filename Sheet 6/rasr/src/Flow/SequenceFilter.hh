 ...
 *
 *  - A new selection is read, if the timestamp of the new data is not contained
 * in the time interval of the current selection.
 *  - Data is filtered out, if the selection object contains 'false' at the
 * position of the data. This implies as well, that selection has to have at
 * least as many elements as data will come in its time interval.
 */
