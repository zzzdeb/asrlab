...
void FullCovMonoGaussianModel::mergeMeans(const FullCovMonoGaussianModel &x,
...
void FullCovMonoGaussianModel::mergeVariance(
    const FullCovMonoGaussianModel &x, const FullCovMonoGaussianModel &y) {
...
const f32 FullCovMonoGaussianModel::relativeLikelihood(
    const FullCovMonoGaussianModel &x) const {
  /* p(this|x) */
  f64 likelihood = 0.0F;
...
void FullCovMonoGaussianModel::mergeModels(const FullCovMonoGaussianModel &x,
                                           const FullCovMonoGaussianModel &y) {
...
// ------------------------------------------------------------------------
void BICFullCovMonoGaussianModel::computeGLR(
    const BICFullCovMonoGaussianModel &x,
...
void BICFullCovMonoGaussianModel::mergeModels(
    const BICFullCovMonoGaussianModel &x,
    const BICFullCovMonoGaussianModel &y) {
...
// ------------------------------------------------------------------------
void KL2FullCovMonoGaussianModel::computeKL2(
    const KL2FullCovMonoGaussianModel &x,
...
void KL2FullCovMonoGaussianModel::mergeModels(
    const KL2FullCovMonoGaussianModel &x,
    const KL2FullCovMonoGaussianModel &y) {
...
void CorrFullCovMonoGaussianModel::correlationDistance(
    CorrFullCovMonoGaussianModel &x, CorrFullCovMonoGaussianModel &y) {
  x.refresh();
  y.refresh();
...
void CorrFullCovMonoGaussianModel::mergeModels(
    CorrFullCovMonoGaussianModel &x, CorrFullCovMonoGaussianModel &y) {
  BICFullCovMonoGaussianModel::mergeModels(x, y);
  correlationDistance(x, y);
}

void CorrFullCovMonoGaussianModel::finalize(
