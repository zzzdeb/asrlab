...
public:
  ...
  /* This vector defines the structure of the tree to be build in pre-order
     direction. TreeStructure = invalidId;  indicates a leaf for building the
     tree.
  */
  ...
  struct Node {
    ...
    Node() : left_(0), right_(0), previous_(0), id_(0), leafNumber_(0){};
  };
...
private:
  ...
  void cutTree(Node *node, Id lastNode, Id cutoff, LeafIndexVector newLeafId,
