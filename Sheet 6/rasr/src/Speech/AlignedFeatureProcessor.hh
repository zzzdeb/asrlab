...
/**
 *  AlignedFeatureProcessor is base class for algorithms processing aligned
 * feature vectors.
 *
 *  The AlignedFeatureProcessor is usually driven by
 * Speech::AlignedFeatureExtractor.
 *
 *  Remark:
 *    an instance of this class can be used for dry runs since it does not have
...
public:
  ...
  /** Override this function to perform preparations before first segment is
   * processed.
   */
  ...
  /** Override this function to implement the processing of Viterbi-aligned
   * feature vectors.
   */
  virtual void processAlignedFeature(Core::Ref<const Feature> f,
                                     Am::AllophoneStateIndex e) {}

  /** Override this function to implement the processing of Baum-Welch-aligned
   * feature vectors.
   */
  virtual void processAlignedFeature(Core::Ref<const Feature>,
                                     Am::AllophoneStateIndex, Mm::Weight) {}

  /** Override this function to implement the processing of feature vectors with
   * two weights.
   */
  virtual void processAlignedFeature(Core::Ref<const Feature>,
                                     Am::AllophoneStateIndex, Mm::Weight,
