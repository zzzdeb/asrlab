...
protected:
  ...
  virtual bool write(const std::string &name, const std::string &buffer,
                     const Sizes &sizes) = 0;
...
public:
  ...
  bool writeFile(const std::string &name, const std::string &ufferb,
                 bool compress = true);
   ...
   **/
  static Archive *create(const Configuration &config,
