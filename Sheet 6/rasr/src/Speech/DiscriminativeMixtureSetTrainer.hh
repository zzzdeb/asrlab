...
public:
  ...
  void accumulateDenominator(Core::Ref<const Feature::Vector> f,
                             Mm::MixtureIndex m, Mm::Weight w);
  void accumulateObjectiveFunction(Mm::Score f);

  static DiscriminativeMixtureSetTrainer *
  createDiscriminativeMixtureSetTrainer(const Core::Configuration &,
                                        bool iSmoothing);
};
