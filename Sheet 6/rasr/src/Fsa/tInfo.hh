...
Fsa::AutomatonCounts count(typename _Automaton::ConstRef f,
                           bool progress = false);
 ...
 **/
template <class _Automaton>
size_t countLinearStates(typename _Automaton::ConstRef f,
                         bool progress = false);
 ...
 **/
template <class _Automaton>
void info(typename _Automaton::ConstRef f, Core::XmlWriter &o,
          bool progress = false);
