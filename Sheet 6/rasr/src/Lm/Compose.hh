...
compose(Fsa::ConstAutomatonRef left, Core::Ref<const Lm::LanguageModel> right,
        Score lmScale, Score syntaxEmissionScale = 1.0);

Core::Ref<const ComposeAutomaton>
compose(Fsa::ConstAutomatonRef left,
...
composePron(Fsa::ConstAutomatonRef left,
            Core::Ref<const Lm::ScaledLanguageModel> right,
            Score pronunciationScale, Score syntaxEmissionScale = 1.0);
