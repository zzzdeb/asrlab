...
void F77NAME(dgelsd)(s32 *m, s32 *n, s32 *nrhs, f64 *a, s32 *lda, f64 *b,
                     s32 *ldb, f64 *s, f64 *rcond, s32 *rank, f64 *work,
...
void F77NAME(dggevx)(char *balanc, char *jobvl, char *jobvr, char *sense,
                     ...
                     double *work, int *lwork, int *iwork, int *bwork,
                     int *info);

void F77NAME(dsyevx)(char *jobz, char *range, char *uplo, int *n, double *a,
...
void F77NAME(dsyevd)(char *jobz, char *uplo, int *n, double *a, int *lda,
                     double *w, double *work, int *lwork, int *iwork,
                     int *liwork, int *info);

void F77NAME(dsyevr)(char *jobz, char *range, char *uplo, int *n, double *a,
                     int *lda, double *vl, double *vu, int *il, int *iu,
                     double *abstol, int *m, double *w, double *z, int *ldz,
                     int *isuppz, double *work, int *lwork, int *iwork,
                     int *liwork, int *info);

void F77NAME(dsygvx)(int *itype, char *jobz, char *range, char *uplo, int *n,
...
void F77NAME(dsygvd)(int *itype, char *jobz, char *uplo, int *n, double *a,
...
void F77NAME(dgelss)(int *m, int *n, int *nrhs, double *A, int *lda, double *B,
                     int *ldb, double *s, double *rcond, int *rank,
                     double *work, int *lwork, int *info);

void F77NAME(sgelss)(int *m, int *n, int *nrhs, float *A, int *lda, float *B,
...
void F77NAME(sgetrs)(char *trans, int *n, int *nrhs, float *A, int *lda,
...
void dggevx(char *balanc, char *jobvl, char *jobvr, char *sense, int *n,
  ...
  F77NAME(dggevx)
  (balanc, jobvl, jobvr, sense, n, a, lda, b, ldb, alphar, alphai, beta, vl,
...
void dsygvx(int *itype, char *jobz, char *range, char *uplo, int *n, double *a,
            int *lda, double *b, int *ldb, double *vl, double *vu, int *il,
            int *iu, double *abstol, int *m, double *w, double *z, int *ldz,
            double *work, int *lwork, int *iwork, int *ifail, int *info) {

  F77NAME(dsygvx)
  (itype, jobz, range, uplo, n, a, lda, b, ldb, vl, vu, il, iu, abstol, m, w, z,
...
void gels(char *trans, int *m, int *n, int *nrhs, float *A, int *lda, float *B,
...
void getri(int *n, float *A, int *lda, int *ipiv, float *work, int *lwork,
           int *info) {

  F77NAME(sgetri)(n, A, lda, ipiv, work, lwork, info);
}

void getri(int *n, double *A, int *lda, int *ipiv, double *work, int *lwork,
           int *info) {
