 ...
 * visualization
 **/
template <class _Automaton> class DrawDotDfsState;

template <class _Automaton> class DotDrawer {
private:
...
public:
  DotDrawer(std::ostream &, Fsa::Hint hints = Fsa::HintNone,
            bool progress = false);
...
bool drawDot(typename _Automaton::ConstRef f, std::ostream &o,
