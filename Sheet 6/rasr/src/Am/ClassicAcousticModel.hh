...
public:
  ...
  ClassicStateModelRef stateModel() const { return stateModelRef_; }
  ...
  ClassicStateTyingRef stateTying() const { return stateTyingRef_; }
  ...
  stateTransition(StateTransitionIndex i) const {
    return (*transitionModel_)[i];
  }
  virtual StateTransitionIndex stateTransitionIndex(AllophoneState phone,
                                                    s8 subState = 0) const {
  ...
  virtual StateTransitionIndex stateTransitionIndex(AllophoneStateIndex e,
                                                    s8 subState = 0) const {
  ...
  hmmTopology(Bliss::Phoneme::Id phoneme) const {
