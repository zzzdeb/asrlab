...
template <> class NameHelper<Flf::ConstLatticeRef> : public std::string {
public:
...
protected:
  virtual Fsa::ConstAutomatonRef transform(Fsa::ConstAutomatonRef fsa1,
                                           Fsa::ConstAutomatonRef) const {
    return fsa1;
  }
...
protected:
  virtual Fsa::ConstAutomatonRef transform(Fsa::ConstAutomatonRef,
                                           Fsa::ConstAutomatonRef) const;
