...
Flf::ConstLatticeRef FtlWrapper::mapInput(Flf::ConstLatticeRef l,
                                          const Fsa::AlphabetMapping &m) {
  return Ftl::mapInput<Flf::Lattice>(l, m);
}
Flf::ConstLatticeRef FtlWrapper::mapOutput(Flf::ConstLatticeRef l,
                                           const Fsa::AlphabetMapping &m) {
  return Ftl::mapOutput<Flf::Lattice>(l, m);
}
Flf::ConstLatticeRef FtlWrapper::mapInputOutput(Flf::ConstLatticeRef l,
                                                const Fsa::AlphabetMapping &m) {
...
Flf::ConstLatticeRef
FtlWrapper::changeSemiring(Flf::ConstLatticeRef l,
...
Flf::ConstLatticeRef FtlWrapper::partial(Flf::ConstLatticeRef l,
                                         Fsa::StateId initial) {
...
Flf::ConstLatticeRef FtlWrapper::nbest(Flf::ConstLatticeRef l, size_t n,
                                       bool bestSequences) {
...
Flf::ConstLatticeRef FtlWrapper::composeMatching(Flf::ConstLatticeRef l,
                                                 Flf::ConstLatticeRef r) {
  return Ftl::composeMatching<Flf::Lattice>(l, r);
}
Flf::ConstLatticeRef FtlWrapper::composeSequencing(Flf::ConstLatticeRef l,
                                                   Flf::ConstLatticeRef r) {
  return Ftl::composeSequencing<Flf::Lattice>(l, r);
}
Flf::ConstLatticeRef FtlWrapper::difference(Flf::ConstLatticeRef l,
                                            Flf::ConstLatticeRef r) {
...
Flf::ConstLatticeRef FtlWrapper::determinize(Flf::ConstLatticeRef l,
                                             bool disambiguate) {
  return Ftl::determinize<Flf::Lattice>(l, disambiguate);
}

#include <Fsa/tDraw.hh>
bool FtlWrapper::drawDot(Flf::ConstLatticeRef l, std::ostream &o,
                         Fsa::Hint hint, bool progress) {
  return Ftl::drawDot<Flf::Lattice>(l, o, hint, progress);
}
bool FtlWrapper::drawDot(Flf::ConstLatticeRef l, const std::string &file,
                         Fsa::Hint hint, bool progress) {
...
size_t FtlWrapper::countInput(Flf::ConstLatticeRef l, Fsa::LabelId label,
                              bool progress) {
  return Ftl::countInput<Flf::Lattice>(l, progress);
}
size_t FtlWrapper::countOutput(Flf::ConstLatticeRef l, Fsa::LabelId label,
                               bool progress) {
  return Ftl::countOutput<Flf::Lattice>(l, progress);
}
void FtlWrapper::info(Flf::ConstLatticeRef l, Core::XmlWriter &o,
                      bool progress) {
...
bool isLinear(Flf::ConstLatticeRef l) { return Ftl::isLinear<Flf::Lattice>(l); }
...
Flf::ConstLatticeRef FtlWrapper::sort(Flf::ConstLatticeRef l,
                                      Fsa::SortType type) {
