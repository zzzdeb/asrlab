...
/*****************************************************************************/
DirectoryArchive::DirectoryArchive(const Core::Configuration &config,
...
/*****************************************************************************/
bool DirectoryArchive::probe(const std::string &file,
                             const struct stat64 &state, Sizes &sizes) const
/*****************************************************************************/
{
  ...
  if (fread(tmp, 1, 2, fp) == 2) {
    if ((tmp[0] == 0x1f) && (tmp[1] == 0x8b)) {
      ...
      if (fread(tmp, 1, 4, fp) == 4) {
        ...
        sizes.setUncompressed(tmp[0] | (u32(tmp[1]) << 8) |
...
/*****************************************************************************/
bool DirectoryArchive::write(const std::string &name, const std::string &buffer,
                             const Sizes &sizes)
/*****************************************************************************/
{
