...
template <class Pointer, class Hash, class Equality> class PointerIndexMap {
public:
...
public:
  ...
  size_t operator[](Pointer pointer) const {
    typename PointerToIndexMap::const_iterator result =
        pointerToIndex_.find(pointer);
...
class ReferenceIndexMap
    : public PointerIndexMap<Core::Ref<Referenced>, hashReference<Referenced>,
