 ...
 */
bool isWhitespaceNormalized(const std::string &s,
...
*/
template <typename T> bool strconv(const std::string &, T &);
...
*/
template <typename T> bool strconv(const std::string &, T &, const Choice &);
...
template <typename T>
bool str2vector(const std::string &, std::vector<T> &,
                const std::string &elemDelim, const std::string &rangeDelim,
                const T &min = Core::Type<T>::min,
                const T &max = Core::Type<T>::max, const T &step = T(1));
...
*/
/*****************************************************************************/
template <typename T> bool strconv(const std::string &s, T &t) {
...
*/
/*****************************************************************************/
template <typename Signed> bool str2signed(const std::string &s, Signed &i) {
  std::string::size_type a = s.find_first_not_of(utf8::whitespace);
  std::string::size_type b = s.find_last_not_of(utf8::whitespace);
...
template <typename Float> bool str2float(const std::string &s, Float &f) {
  std::string::size_type a = s.find_first_not_of(utf8::whitespace);
  std::string::size_type b = s.find_last_not_of(utf8::whitespace);
  if (a == std::string::npos)
    return false;
...
template <> inline bool strconv<bool>(const std::string &s, bool &b) {
  return strconv(s, b, boolChoice);
}

template <> inline bool strconv(const std::string &s, s8 &i) {
  return str2signed(s, i);
}
template <> inline bool strconv(const std::string &s, s16 &i) {
  return str2signed(s, i);
}
template <> inline bool strconv(const std::string &s, s32 &i) {
  return str2signed(s, i);
}
#if defined(HAS_64BIT)
template <> inline bool strconv(const std::string &s, s64 &i) {
  return str2signed(s, i);
}
#endif
template <> inline bool strconv(const std::string &s, u8 &u) {
  return str2unsigned(s, u);
}
template <> inline bool strconv(const std::string &s, u16 &u) {
  return str2unsigned(s, u);
}
template <> inline bool strconv(const std::string &s, u32 &u) {
  return str2unsigned(s, u);
}
#if defined(HAS_64BIT)
template <> inline bool strconv(const std::string &s, u64 &u) {
  return str2unsigned(s, u);
}
#endif
template <> inline bool strconv(const std::string &s, f32 &f) {
  return str2float(s, f);
}
template <> inline bool strconv(const std::string &s, f64 &f) {
  return str2float(s, f);
}
/*****************************************************************************/
...
*/
/*****************************************************************************/
template <> inline bool strconv(const std::string &s, std::string &ss) {
  std::string::size_type a = s.find_first_not_of(utf8::whitespace);
  std::string::size_type b = s.find_last_not_of(utf8::whitespace);
...
bool str2vector(const std::string &s, std::vector<T> &e,
                const std::string &elemDelim, const std::string &rangeDelim,
                const T &minValue, const T &maxValue, const u32 &minSize,
                const u32 &maxSize, const T &step) {
  require(!elemDelim.empty());
  ...
  while (start != std::string::npos) {
    ...
    if (center != std::string::npos) {
      if (!strconv(slice.substr(0, center), rangeStart) ||
          !strconv(
              slice.substr(std::min(center + rangeDelim.size(), slice.size())),
              rangeEnd))
        return false;
      ...
      if ((minValue <= t) && (t <= maxValue))
        ...
        std::cerr << "the given string contains out of range values."
                  << std::endl;
        return false;
      }
    }
  ...
  if ((e.size() >= minSize) && (e.size() <= maxSize))
    ...
    std::cerr << "configuration error: ";
    std::cerr << "the given string has an incorrect number of elements."
              << std::endl;
    return false;
  }
}
...
bool str2vector(const std::string &s, std::vector<T> &e,
                const std::string &elemDelim, const std::string &rangeDelim,
                const std::string &assignDelim, const T &minValue,
                const T &maxValue, const u32 &minSize, const u32 &maxSize,
                const T &step) {
  require(!elemDelim.empty());
  require(!rangeDelim.empty());
  ...
  while (start != std::string::npos) {
    ...
    if (assignPoint != std::string::npos) {
      if (!strconv(wholeSlice.substr(std::min(assignPoint + assignDelim.size(),
                                              wholeSlice.size())),
                   weight))
        return false;
      ...
      if (center != std::string::npos) {
        if (!strconv(slice.substr(0, center), rangeStart) ||
            !strconv(slice.substr(
                         std::min(center + rangeDelim.size(), slice.size())),
                     rangeEnd))
          return false;
...
template <> inline bool strconv(const std::string &s, std::vector<u8> &v) {
  return str2vector(s, v, ",", ":");
}
template <> inline bool strconv(const std::string &s, std::vector<u16> &v) {
  return str2vector(s, v, ",", ":");
}
template <> inline bool strconv(const std::string &s, std::vector<u32> &v) {
  return str2vector(s, v, ",", ":");
}
#if defined(HAS_64BIT)
template <> inline bool strconv(const std::string &s, std::vector<u64> &v) {
  return str2vector(s, v, ",", ":");
}
#endif

template <> inline bool strconv(const std::string &s, std::vector<s8> &v) {
  return str2vector(s, v, ",", ":");
}
template <> inline bool strconv(const std::string &s, std::vector<s16> &v) {
  return str2vector(s, v, ",", ":");
}
template <> inline bool strconv(const std::string &s, std::vector<s32> &v) {
  return str2vector(s, v, ",", ":");
}
#if defined(HAS_64BIT)
template <> inline bool strconv(const std::string &s, std::vector<s64> &v) {
  return str2vector(s, v, ",", ":");
}
#endif

template <> inline bool strconv(const std::string &s, std::vector<f32> &v) {
  return str2vector(s, v, ",", ":");
}
template <> inline bool strconv(const std::string &s, std::vector<f64> &v) {
  return str2vector(s, v, ",", ":");
}
/*****************************************************************************/
...
inline bool strconv(const std::string &s, std::vector<std::string> &v) {
  ...
  while (start != std::string::npos) {
    ...
    if (end == std::string::npos) {
      v.back() =
          s.substr(start, s.find_last_not_of(utf8::whitespace) - start + 1);
      start = std::string::npos;
    } else {
      v.back() = s.substr(start, s.find_last_not_of(utf8::whitespace, end - 1) -
                                     start + 1);
