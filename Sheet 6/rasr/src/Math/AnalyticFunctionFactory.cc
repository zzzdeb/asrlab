...
AnalyticFunctionFactory::AnalyticFunctionFactory(const Core::Configuration &c)
    : Core::Component(c), sampleRate_(1.0),
...
bool AnalyticFunctionFactory::accept(const std::string &s,
...
bool AnalyticFunctionFactory::accept(UnaryAnalyticFunction::Argument &a,
                                     const std::string &declaration,
                                     std::string::size_type &position) const {
  acceptWhitespaces(declaration, position);
  if (position != std::string::npos) {
...
AnalyticFunctionFactory::castToUnaryFunction(AnalyticFunctionRef r) const {
  const UnaryAnalyticFunction *p =
      dynamic_cast<const UnaryAnalyticFunction *>(r.get());
  if (p == 0) {
    if (r)
...
AnalyticFunctionFactory::castToBinaryFunction(AnalyticFunctionRef r) const {
  const BinaryAnalyticFunction *p =
      dynamic_cast<const BinaryAnalyticFunction *>(r.get());
  if (p == 0) {
    if (r)
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::create(const std::string &declaration,
                                std::string::size_type &position) const {
  AnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseNesting(const std::string &declaration,
                                      std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
  if (accept("nest(", declaration, position)) {
    UnaryAnalyticFunctionRef g =
        castToUnaryFunction(create(declaration, position));
    if (g) {
      if (accept(",", declaration, position)) {
        AnalyticFunctionFactory factory(*this);
        factory.setMaximalArgument(g->value(maximalArgument_));

        UnaryAnalyticFunctionRef f =
            castToUnaryFunction(factory.create(declaration, position));
        if (f) {
          if (accept(")", declaration, position))
            result = nest(f, g);
        }
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseInvertion(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseMaximumNormalization(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseIdentity(const std::string &declaration,
                                       std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseConstant(const std::string &declaration,
                                       std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseOffset(const std::string &declaration,
                                     std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseScaling(const std::string &declaration,
                                      std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseAddition(const std::string &declaration,
                                       std::string::size_type &position) const {
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseSubstraction(
    const std::string &declaration, std::string::size_type &position) const {
  BinaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseMultiplication(
    const std::string &declaration, std::string::size_type &position) const {
  BinaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseDivision(const std::string &declaration,
                                       std::string::size_type &position) const {
  BinaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseSinh(const std::string &declaration,
                                   std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseArcSinh(const std::string &declaration,
                                      std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseCosh(const std::string &declaration,
                                   std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseArcCosh(const std::string &declaration,
                                      std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseDiscreteToContinuous(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseContinuousToDiscrete(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef AnalyticFunctionFactory::createMelWarpingFunction(
    bool discretizeArgument) const {
  switch (domainType_) {
  ...
  case discreteDomain: {
    ...
    if (discretizeArgument)
      scaleInput =
          nest(createFloorFloat(), scaleInput); // creates result uninvertible
    return nest(createScaling(2595.0 * sampleRate_),
                nest(createMelWarpingCore(), scaleInput));
  }
  case normalizedOmegaDomain:
    // sampleRate_: sample rate in time domain
    return nest(
        createScaling(2595.0 * 2 * M_PI / sampleRate_),
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseMelWarpingFunction(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
  if (accept("mel", declaration, position)) {
    bool discretizeArgument =
        accept("(discretize-argument)", declaration, position);
...
UnaryAnalyticFunctionRef
AnalyticFunctionFactory::createBarkWarpingFunction() const {
  UnaryAnalyticFunctionRef continuous =
      nest(createScaling(6.0),
           nest(createSinh()->invert(), createScaling(1.0 / 600.0)));
  switch (domainType_) {
  case continuousDomain:
    return continuous;
  case discreteDomain:
    // sampleRate_: sample rate of the frequency axis
    return nest(createScaling(sampleRate_),
                nest(continuous, createScaling(1 / sampleRate_)));
  case normalizedOmegaDomain:
    // sampleRate_: sample rate in time domain
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseBarkWarpingFunction(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseTwoPieceLinearFunction(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseBilinearWarpingFunction(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef
AnalyticFunctionFactory::createThreePieceAffineFunction(
    UnaryAnalyticFunction::Argument warpingFactor,
  ...
  require(0 < lowerLimit && lowerLimit < upperLimit && upperLimit < 1 &&
          aShift >= 0);
  if (warpingFactor <= 1) {
    PiecewiseLinearFunction *result = new PiecewiseLinearFunction;
    ...
    inverse.add(lowerLimit * maximalArgument_,
                ((1 / warpingFactor) * lowerLimit * maximalArgument_ +
                 aShift * ((1 / warpingFactor) - 1)) /
                    (lowerLimit * maximalArgument_));
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseThreePieceAffineFunction(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
              ...
              if (accept(",", declaration, position)) {
                ...
                if (accept(lowerLimit, declaration, position)) {
                  if (0.0350 < lowerLimit && lowerLimit < 1) {
                    if (accept(",", declaration, position)) {
                      ...
                      if (accept(upperLimit, declaration, position)) {
                        if (lowerLimit < upperLimit && upperLimit < 1) {
                          ...
                          error("Upper-Limit has to be greater than "
                                "'lower-limit' "
                                "and less than 1.");
                        }
                      }
                    ...
                    error(
                        "Lower-Limit has to lie in the interval (0.0350, 1).");
                  }
                }
              }
            } else {
              error("Reasonable a-shift are usually expected in the interval "
                    "[0, 1500].");
            }
          }
        }
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseEqualLoudnessPreemphasis(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef
AnalyticFunctionFactory::createEqualLoudnessPreemphasis() const {
  UnaryAnalyticFunctionRef result;
  switch (domainType_) {
  case continuousDomain: {
    if (Core::isSignificantlyGreater(
            maximalArgument_, (UnaryAnalyticFunction::Argument)4000, 1e12))
...
AnalyticFunctionFactory::AnalyticFunctionRef
AnalyticFunctionFactory::parseEqualLoudnessPreemphasis40dB(
    const std::string &declaration, std::string::size_type &position) const {
  UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef
AnalyticFunctionFactory::createEqualLoudnessPreemphasis40dB() const {
  UnaryAnalyticFunctionRef result;
  switch (domainType_) {
  case continuousDomain: {
