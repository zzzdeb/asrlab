...
Preemphasis::Preemphasis()
    : alpha_(1.0), previous_(0), previousEndTime_(0), sampleRate_(0),
      needInit_(true) {}
...
Core::ParameterFloat
    Signal::PreemphasisNode::paramAlpha("alpha", "preemphasis weight", 1);
...
bool PreemphasisNode::setParameter(const std::string &name,
