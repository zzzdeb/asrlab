...
public:
  ...
  createAligningFeatureExtractor(const Core::Configuration &,
                                 AlignedFeatureProcessor &) const;

  MixtureSetTrainer *
  createMixtureSetTrainer(const Core::Configuration &configuration) const;
...
#ifdef MODULE_SPEECH_DT
  DiscriminativeMixtureSetTrainer *createDiscriminativeMixtureSetTrainer(
      const Core::Configuration &configuration) const;
  SegmentwiseGmmTrainer *
  createSegmentwiseGmmTrainer(const Core::Configuration &configuration) const;
  LatticeRescorer *
  createDistanceLatticeRescorer(const Core::Configuration &configuration,
