...
namespace Ftl {
template <class _Automaton> class StorageAutomaton : public _Automaton {
...
public:
  ...
  virtual _State *createState(Fsa::StateId id = 0,
                              Fsa::StateTag tags = Fsa::StateTagNone) const;
  virtual _State *createState(Fsa::StateId id, Fsa::StateTag tags,
                              const _Weight &) const;
