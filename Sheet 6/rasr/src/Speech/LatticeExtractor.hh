...
public:
  ...
  virtual Lattice::ConstWordLatticeRef extract(Lattice::ConstWordLatticeRef,
                                               Bliss::SpeechSegment *);
...
protected:
  virtual Lattice::ConstWordLatticeRef work(Lattice::ConstWordLatticeRef,
                                            Bliss::SpeechSegment *) = 0;
...
public:
  LmLatticeRescorer(const Core::Configuration &, bool initialize = true);
...
public:
  ...
  enum SpokenSource { orthography, archive };
...
public:
  ...
  static LatticeRescorer *
  createDistanceLatticeRescorer(const Core::Configuration &, Bliss::LexiconRef);
};
...
protected:
  virtual Lattice::ConstWordLatticeRef work(Lattice::ConstWordLatticeRef,
                                            Bliss::SpeechSegment *);
  virtual Fsa::ConstAutomatonRef getDistanceFsa(Lattice::ConstWordLatticeRef,
                                                Bliss::SpeechSegment *) {
    return Fsa::ConstAutomatonRef();
  }

public:
  ApproximateDistanceLatticeRescorer(const Core::Configuration &,
                                     Bliss::LexiconRef);
...
public:
  ArchiveApproximateWordAccuracyLatticeRescorer(const Core::Configuration &,
                                                Bliss::LexiconRef);
...
public:
  OrthographyApproximateWordAccuracyLatticeRescorer(const Core::Configuration &,
                                                    Bliss::LexiconRef);
...
public:
  ApproximatePhoneAccuracyLatticeRescorer(const Core::Configuration &,
                                          Bliss::LexiconRef);
...
public:
  ArchiveApproximatePhoneAccuracyLatticeRescorer(const Core::Configuration &,
                                                 Bliss::LexiconRef);
