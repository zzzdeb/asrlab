...
/** CorpusKey: template for combining copus section names. E.g
 * "$(coprus)/$(speaker).xxx" They can be used as identifier for the currently
 * processed objects (e.g. speaker dependent estimation). CorpusVisitor resolves
 * the copus section names in the template.
 */
