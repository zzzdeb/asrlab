...
public:
  template <typename V>
  XmlFull(const std::string &element, const V &value) : XmlOpen(element) {
    std::ostringstream ss;
    ss << value;
    content_ = ss.str();
  }
...
#if 1
  //	Self &operator<<(std::omanip  t) { std::ostream::operator<<(t); return
  //*this; } 	Self &operator<<(std::manip   t) { std::ostream::operator<<(t);
  //return *this; }
  Self &operator<<(s8 t) {
...
public:
  ...
  void setEncoding(
      const std::string &encoding = UnicodeOutputConverter::defaultEncoding) {
...
// 	}
// #else
//       //	Self &operator<<(std::__omanip t) { XmlWriter::operator<<(t);
//       return *this; }
//       //	Self &operator<<(std::__manip  t) { XmlWriter::operator<<(t);
//       return *this; }
// 	Self &operator<<(s8           t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(u8           t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(s16          t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(u16          t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(s32          t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(u32          t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(f32          t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(f64          t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(bool         t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(void        *t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(const  char *t) { XmlWriter::operator<<(t); return
// *this; }
// 	//      	Self &operator<<(const uchar *t) {
// XmlWriter::operator<<(t); return *this; } 	Self &operator<<(const std::string
// &s) { XmlWriter &os(*this); os << s; return *this; }
//       //	Self &operator<<(const std::string &s) { XmlWriter &os(*this);
//       os << s; return *this; }
// 	Self &operator<<(const XmlOpen         &t) { XmlWriter::operator<<(t);
// return *this; } 	Self &operator<<(const XmlClose        &t) {
// XmlWriter::operator<<(t); return *this; } 	Self &operator<<(const XmlEmpty &t)
// { XmlWriter::operator<<(t); return *this; } 	Self &operator<<(const XmlFull
// &t) { XmlWriter::operator<<(t); return *this; } 	Self &operator<<(const
// XmlComment      &t) { XmlWriter::operator<<(t); return *this; } 	Self
// &operator<<(const XmlOpenComment  &t) { XmlWriter::operator<<(t); return
// *this; } 	Self &operator<<(const XmlCloseComment &t) {
// XmlWriter::operator<<(t); return *this; } #endif
//     };
