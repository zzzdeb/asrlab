...
public:
  struct TracebackItem {
    ...
    Score score;
    Time time;
    TracebackItem(Word w, Score s, Time t) : word(w), score(s), time(t) {}
  };
...
public:
  ...
  virtual void
  getCurrentBestSentence(Search::SearchAlgorithm::Traceback &) const;
...
public:
  Scorer(SearchInterface *parent) : parent_(parent) {}
 ...
 */
class SearchInterface::AcousticModelScorer : public SearchInterface::Scorer {
public:
  AcousticModelScorer(SearchInterface *p) : Scorer(p) {}
 ...
 */
class SearchInterface::LanguageModelScorer : public SearchInterface::Scorer {
public:
  LanguageModelScorer(SearchInterface *p) : Scorer(p) {}
 ...
 */
class SearchInterface::TransitionModelScorer : public SearchInterface::Scorer {
public:
  TransitionModelScorer(SearchInterface *p) : Scorer(p) {}
