...
**/
typedef s32 LabelId;
// must be -1 due to optimized composition/determinization and hardcoded index
// shift for AT&T format
...
static const LabelId Else =
    2147483647 - 3; // if no other arc matches, replaced by epsilon
