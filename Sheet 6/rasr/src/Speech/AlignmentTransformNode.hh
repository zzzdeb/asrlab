 ...
 *  Derive from this class to encapsulate unary function computations on
 * alignments in Flow.
 */
 ...
 *  Derive from this class to encapsulate binary function computations on
 * alignments in Flow.
 */
...
class SetAlignmentWeightsByTiedStateAlignmentWeightsNode
