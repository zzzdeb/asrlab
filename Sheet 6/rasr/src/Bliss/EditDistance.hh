...
public:
  ...
  struct AlignmentItem {
    const Token *a, *b;
    EditOperation op;
    AlignmentItem(const Bliss::Token *_a, const Bliss::Token *_b,
                  EditOperation _op)
        : a(_a), b(_b), op(_op) {}
...
private:
  mutable Core::Statistics<u32> statSearchSpace_, statMaxStackSize_,
      statNExpansions_;
...
public:
  ...
  void align(Fsa::ConstAutomatonRef, Fsa::ConstAutomatonRef,
             Alignment &out) const;
};
