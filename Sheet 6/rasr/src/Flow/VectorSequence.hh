 ...
 * All input packets must be vectors, which will be put into a sequence of
 * vectors.
 *
 ...
 */
const Core::ParameterBool paramVectorSequenceNodeReverse(
    "reverse",
    "if true, indices run backwards starting at the back of the inputs", false);
const Core::ParameterBool paramVectorSequenceNodeTimeStamp(
    "timestamp", "if true, change timestamp in the sequence", false);
