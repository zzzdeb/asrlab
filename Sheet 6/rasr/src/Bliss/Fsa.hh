...
public:
  ...
  const LemmaPronunciationAlphabet *lemmaPronunciationAlphabet() const {
    return dynamic_cast<const LemmaPronunciationAlphabet *>(
...
public:
  ...
  const SyntacticTokenAlphabet *syntacticTokenAlphabet() const {
    return dynamic_cast<const SyntacticTokenAlphabet *>(
        getOutputAlphabet().get());
  }
};
...
public:
  ...
  const EvaluationTokenAlphabet *evaluationTokenAlphabet() const {
    return dynamic_cast<const EvaluationTokenAlphabet *>(
        getOutputAlphabet().get());
  }
};
