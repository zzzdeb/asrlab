...
// ===========================================================================
const Core::ParameterFloat RawSourceNode::paramSampleRate("sample-rate",
                                                          "sampling rate in Hz",
                                                          16000, 0);
const Core::ParameterInt
    RawSourceNode::paramSampleSize("sample-size", "sampling resolution in bits",
                                   16, 1);
const Core::ParameterInt RawSourceNode::paramTracks("track-count",
...
bool RawSourceNode::setParameter(const std::string &name,
...
bool RawFileInputNode::setParameter(const std::string &name,
                                    const std::string &value) {
...
void RawFileInputNode::closeFile_() { bis_.close(); }
