...
public:
  Channel(const Configuration &, const std::string &name,
          Default defaultTarget = disabled, TargetType __type = plainTarget);
  virtual ~Channel();
...
public:
  XmlChannel(const Configuration &, const std::string &name,
...
class Channel::Manager : public Configurable, private Core::Mutex {
private:
  ...
  Channel::Target *createTarget(TargetType, const Core::Configuration &,
