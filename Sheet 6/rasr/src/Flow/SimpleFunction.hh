 ...
 */
template <class A, class P> class SimpleFunction {
public:
...
template <class T> class LnFunction : public SimpleFunction<DataAdaptor<T>, T> {
public:
...
const Core::ParameterFloat paramSimpleFunctionParameter("value",
                                                        "parametric value", 0);

template <class Function> class SimpleFunctionNode : public SleeveNode {
public:
...
template <class Function> bool SimpleFunctionNode<Function>::configure() {
...
template <class Function>
bool SimpleFunctionNode<Function>::setParameter(const std::string &name,
...
template <class Function> bool SimpleFunctionNode<Function>::work(PortId p) {
