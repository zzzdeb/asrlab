...
public:
  ChangeInputAlphabetAutomaton(ConstAutomatonRef f,
                               const Fsa::ConstAlphabetRef a)
...
public:
  ChangeOutputAlphabetAutomaton(ConstAutomatonRef f,
                                const Fsa::ConstAlphabetRef a)
...
public:
  ChangeInputOutputAlphabetAutomaton(ConstAutomatonRef f,
                                     const Fsa::ConstAlphabetRef a)
...
public:
  OutputMappedAutomaton(ConstAutomatonRef f,
                        const Fsa::AlphabetMapping &mapping)
      : Precursor(f, mapping) {}
  virtual Fsa::ConstAlphabetRef getOutputAlphabet() const {
    return Precursor::mapping_.to();
  }
...
public:
  InputOutputMappedAutomaton(ConstAutomatonRef f,
                             const Fsa::AlphabetMapping &mapping)
      : Precursor(f, mapping) {}
  virtual Fsa::Type type() const { return Precursor::fsa_->type(); }
  virtual Fsa::ConstAlphabetRef getInputAlphabet() const {
    return Precursor::mapping_.to();
  }
  virtual Fsa::ConstAlphabetRef getOutputAlphabet() const {
...
template <class _Automaton>
typename _Automaton::ConstRef mapInput(typename _Automaton::ConstRef f,
                                       const Fsa::AlphabetMapping &mapping) {
  ...
  if (!mapping.isModifyingType())
    return typename _Automaton::ConstRef(
        new ChangeInputAlphabetAutomaton<_Automaton>(f, mapping.to()));
  return typename _Automaton::ConstRef(
      new InputMappedAutomaton<_Automaton>(f, mapping));
}
template <class _Automaton>
typename _Automaton::ConstRef mapOutput(typename _Automaton::ConstRef f,
                                        const Fsa::AlphabetMapping &mapping) {
  ...
  if (!mapping.isModifyingType())
    return typename _Automaton::ConstRef(
        new ChangeOutputAlphabetAutomaton<_Automaton>(f, mapping.to()));
  return typename _Automaton::ConstRef(
      new OutputMappedAutomaton<_Automaton>(f, mapping));
}
template <class _Automaton>
typename _Automaton::ConstRef
mapInputOutput(typename _Automaton::ConstRef f,
               const Fsa::AlphabetMapping &mapping) {
  require(f->getInputAlphabet() == mapping.from() || !mapping.to());
  require(f->getOutputAlphabet() == mapping.from() || !mapping.to());
  if (mapping.type() & Fsa::AlphabetMapping::typeIdentity)
  ...
  if (!mapping.isModifyingType())
    return typename _Automaton::ConstRef(
        new ChangeInputOutputAlphabetAutomaton<_Automaton>(f, mapping.to()));
  return typename _Automaton::ConstRef(
      new InputOutputMappedAutomaton<_Automaton>(f, mapping));
}

template <class _Automaton>
typename _Automaton::ConstRef mapInput(typename _Automaton::ConstRef f,
                                       Fsa::ConstAlphabetRef a,
                                       u32 reportUnknowns) {
  Fsa::AlphabetMapping mapping;
  mapAlphabet(f->getInputAlphabet(), a, mapping, Fsa::InvalidLabelId,
              reportUnknowns);
...
typename _Automaton::ConstRef mapOutput(typename _Automaton::ConstRef f,
                                        ...
                                        u32 reportUnknowns) {
  Fsa::AlphabetMapping mapping;
  mapAlphabet(f->getOutputAlphabet(), a, mapping, Fsa::InvalidLabelId,
              reportUnknowns);
  return mapOutput<_Automaton>(f, mapping);
}
template <class _Automaton>
typename _Automaton::ConstRef mapInputOutput(typename _Automaton::ConstRef f,
                                             Fsa::ConstAlphabetRef a,
                                             u32 reportUnknowns) {
