 ...
 *
 * This Node is capabable of handling an arbitrary number of input and output
 * ports. If specified all actions performed within an instance of this Node in
 * a given FLOW network will be documented using different log channels.
 *
 * Additionally, all data passing through an instance of this node can be dumped
 * into files.
 *
...
public:
  ...
  // fullName is inherited from Core::Configurable and returns the runtime name
  // of this node i.e. the configuration path
  virtual ~DemoNode();
