...
/*****************************************************************************/
HmmTopologySetParser::HmmTopologySetParser(HmmTopologySet &hset,
...
/*****************************************************************************/
{
  ...
  XmlElement *network_decl = new XmlMixedElementRelay(
      "hmm-topology-set", this, startHandler(&Self::start_network),
...
/*****************************************************************************/
{
  ...
  if (!name)
    error("hmm topology has no name");
  else
    network.addParameter(reinterpret_cast<const char *>(name));
}
