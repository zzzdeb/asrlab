...
Attributes::Parser::Parser(const Core::Configuration &c)
    : Core::XmlSchemaParser(c), attribs_(0) {
  setRoot(new Core::XmlMixedElementRelay(
      "flow-attributes", this, 0, 0, 0,
      XML_CHILD(new Core::XmlEmptyElementRelay(
          "flow-attribute", this, startHandler(&Self::startAttribute))),
...
bool Attributes::Parser::buildFromString(Attributes &attribs,
...
bool Attributes::Parser::buildFromFile(Attributes &attribs,
