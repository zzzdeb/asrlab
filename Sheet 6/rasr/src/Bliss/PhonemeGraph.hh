...
public:
  ...
  PhonemeGraphNodeInfo(const PhonemeGraphNodeInfo &o) : flags_(o.flags_) {}
};

class PhonemeGraphNode : public PhonemeGraph::NodeBase,
                         public PhonemeGraphNodeInfo {
public:
  PhonemeGraphNode(const PhonemeGraphNodeInfo &o) : PhonemeGraphNodeInfo(o) {}
...
public:
  ...
  void setPronunciation(const Pronunciation *pron) { pronunciation_ = pron; }

  PhonemeGraphEdgeInfo(const Phoneme *phon, const Pronunciation *pron)
      : phoneme_(phon), pronunciation_(pron) {}
};

class PhonemeGraphEdge : public PhonemeGraph::EdgeBase,
...
class PhonemeGraphBuilder : public Core::Component {
private:
  LexiconRef lexicon_;
  bool optimize_;
...
public:
  ...
  void addPronunciation(PhonemeGraph &graph, PhonemeGraph::Node *from,
