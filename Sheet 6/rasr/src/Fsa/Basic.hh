 ...
 */
namespace Fsa {
ConstAutomatonRef mapInput(ConstAutomatonRef f, ConstAlphabetRef alphabet,
                           u32 reportUnknowns = 10);
ConstAutomatonRef mapOutput(ConstAutomatonRef f, ConstAlphabetRef alphabet,
                            u32 reportUnknowns = 10);
ConstAutomatonRef mapInputOutput(ConstAutomatonRef, ConstAlphabetRef,
                                 u32 reportUnknowns = 10);
