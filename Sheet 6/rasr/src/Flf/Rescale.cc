...
const Core::ParameterFloat RescaleNode::paramScale("scale", "new scale",
                                                   Semiring::UndefinedScale);
const Core::ParameterString RescaleNode::paramKey("key", "new key name", "");
