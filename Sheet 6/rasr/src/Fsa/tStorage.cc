...
StorageAutomaton<_Automaton>::StorageAutomaton(Fsa::Type type)
    : type_(type), initial_(Fsa::InvalidStateId) {
  _Automaton::setProperties(Fsa::PropertyStorage | Fsa::PropertyCached,
                            Fsa::PropertyAll);
}
...
template <class _Automaton>
void StorageAutomaton<_Automaton>::addProperties(
...
template <class _Automaton>
void StorageAutomaton<_Automaton>::setProperties(
    Fsa::Property knownProperties, Fsa::Property properties) const {
...
template <class _Automaton>
void StorageAutomaton<_Automaton>::unsetProperties(
    Fsa::Property unknownProperties) const {
  unknownProperties &= ~(Fsa::PropertyStorage | Fsa::PropertyCached);
  _Automaton::unsetProperties(unknownProperties);
}

template <class _Automaton>
Core::Ref<const typename _Automaton::Semiring>
StorageAutomaton<_Automaton>::semiring() const {
  return semiring_;
}
...
template <class _Automaton> void StorageAutomaton<_Automaton>::normalize() {}

template <class _Automaton>
typename _Automaton::State *
StorageAutomaton<_Automaton>::createState(Fsa::StateId id,
                                          Fsa::StateTag tags) const {
  return new typename _Automaton::State(id, tags);
}

template <class _Automaton>
typename _Automaton::State *StorageAutomaton<_Automaton>::createState(
    Fsa::StateId id, Fsa::StateTag tags,
    const typename _Automaton::Weight &weight) const {
