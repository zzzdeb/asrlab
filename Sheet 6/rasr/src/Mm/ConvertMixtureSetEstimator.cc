 ...
 */
ConvertMixtureSetEstimator::ConvertMixtureSetEstimator(
...
ConvertMixtureSetEstimator::createDensityEstimator() {
  return new ConvertGaussDensityEstimator;
}

ConvertGaussDensityEstimator *
ConvertMixtureSetEstimator::createDensityEstimator(const GaussDensity &) {
  return new ConvertGaussDensityEstimator;
}
...
ConvertMixtureSetEstimator::createMeanEstimator(const Mean &mean) {
  return new ConvertMeanEstimator(mean.size());
}

ConvertCovarianceEstimator *
ConvertMixtureSetEstimator::createCovarianceEstimator() {
...
void ConvertMixtureSetEstimator::setMixtureSet(
