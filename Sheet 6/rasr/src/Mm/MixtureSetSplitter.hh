...
private:
  ...
  MeanIndex splitMean(MixtureSet &mixtureSet, MeanIndex index,
                      std::vector<MeanType> &perturbation);

  std::vector<CovarianceIndex> splittedCovariances_;
  Weight minCovarianceObservationWeight_;
  void splitCovariances(MixtureSet &mixtureSet,
                        const std::vector<Weight> &weights);
  CovarianceIndex splitCovariance(MixtureSet &mixtureSet,
