...
// -------------------------------------------------------------------------
template <>
void WrapperAutomaton<Fsa::Automaton, Flf::Lattice>::setMaster(
    Fsa::ConstAutomatonRef f) {}

template <>
void WrapperAutomaton<Flf::Lattice, Flf::Lattice>::setMaster(
    Flf::ConstLatticeRef f) {
...
RescoreLattice::~RescoreLattice() { delete rescore_; }
